...
#define SYSCFG_BOOT_SRAM                                                                                               \
    (SYSCFG_CFGR1_MEM_MODE_1 | SYSCFG_CFGR1_MEM_MODE_0) /*!< Embedded SRAM mapped at 0x0000 0000                       \
                                                         */
 ...
 * @{
 */
#define SYSCFG_BREAK_SP                                                                                                \
    SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM Parity error signal with                                          \
                        Break Input of TIM1/15/16/17 */
#if defined(SYSCFG_CFGR2_PVDL)
#define SYSCFG_BREAK_PVD                                                                                               \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with                                                   \
                         TIM1/15/16/17 Break Input and also the PVDE and PLS                                           \
                         bits of the Power Control Interface */
#endif                /* SYSCFG_CFGR2_PVDL */
#define SYSCFG_BREAK_LOCKUP                                                                                            \
    SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP output of CortexM0+                                             \
                        with Break Input of TIM1/15/16/17 */
#define SYSCFG_BREAK_ECC                                                                                               \
    SYSCFG_CFGR2_ECCL /*!< Enables and locks the ECC of CortexM0+ with Break                                           \
                         Input of TIM1/15/16/17 */
    /**
     * @}
     */
...
#define HAL_SYSCFG_IRDA_ENV_SEL_TIM16                                                                                  \
    (SYSCFG_CFGR1_IR_MOD_0 & SYSCFG_CFGR1_IR_MOD_1) /*!< 00: Timer16 is selected as IR Modulation                      \
                                                       envelope source */
#define HAL_SYSCFG_IRDA_ENV_SEL_USART1                                                                                 \
    (SYSCFG_CFGR1_IR_MOD_0) /*!< 01: USART1 is selected as IR Modulation                                               \
                               envelope source */
#if defined(USART4)
#define HAL_SYSCFG_IRDA_ENV_SEL_USART4                                                                                 \
    (SYSCFG_CFGR1_IR_MOD_1) /*!< 10: USART4 is selected as IR Modulation                                               \
                               envelope source */
#else
#define HAL_SYSCFG_IRDA_ENV_SEL_USART2                                                                                 \
    (SYSCFG_CFGR1_IR_MOD_1) /*!< 10: USART2 is selected as IR Modulation                                               \
                               envelope source */
#endif                      /* USART4 */
...
#define SYSCFG_VREFBUF_VOLTAGE_SCALE0                                                                                  \
    0x00000000U /*!< Voltage reference scale 0: VREF_OUT1 around 2.048 V.                                              \
                     This requires VDDA equal to or higher than 2.4 V.   */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE1                                                                                  \
    VREFBUF_CSR_VRS /*!< Voltage reference scale 1: VREF_OUT1 around 2.5 V.                                            \
...
#define SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE                                                                          \
    0x00000000U                                              /*!< VREF_plus pin is internally connected to Voltage     \
...
/** @defgroup SYSCFG_FastModePlus_I2Cx Fast mode Plus driving capability
 * activation for I2Cx
 * @{
 */
...
#define HAL_ITLINE_PVDOUT                                                                                              \
    ((HAL_SYSCFG_ITLINE1 << 0x18U) | SYSCFG_ITLINE1_SR_PVDOUT) /*!< Power voltage detection Interrupt .... */
#endif                                                         /* PWR_PVD_SUPPORT */
#if defined(PWR_PVM_SUPPORT)
#define HAL_ITLINE_PVMOUT                                                                                              \
    ((HAL_SYSCFG_ITLINE1 << 0x18U) | SYSCFG_ITLINE1_SR_PVMOUT) /*!< Power voltage monitor Interrupt .... */
#endif                                                         /* PWR_PVM_SUPPORT */
#define HAL_ITLINE_RTC ((HAL_SYSCFG_ITLINE2 << 0x18U) | SYSCFG_ITLINE2_SR_RTC) /*!< RTC -> exti[19] Interrupt */
#define HAL_ITLINE_TAMPER                                                                                              \
    ((HAL_SYSCFG_ITLINE2 << 0x18U) | SYSCFG_ITLINE2_SR_TAMPER) /*!< TAMPER -> exti[21] interrupt .... */
...
#define HAL_ITLINE_DMA1_CH2                                                                                            \
    ((HAL_SYSCFG_ITLINE10 << 0x18U) | SYSCFG_ITLINE10_SR_DMA1_CH2) /*!< DMA1 Channel 2 Interrupt */
#define HAL_ITLINE_DMA1_CH3                                                                                            \
    ((HAL_SYSCFG_ITLINE10 << 0x18U) | SYSCFG_ITLINE10_SR_DMA1_CH3) /*!< DMA1 Channel 3 Interrupt */
...
#define HAL_ITLINE_DMA1_CH4                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA1_CH4) /*!< DMA1 Channel 4 Interrupt */
#define HAL_ITLINE_DMA1_CH5                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA1_CH5) /*!< DMA1 Channel 5 Interrupt */
#if defined(DMA1_Channel7)
#define HAL_ITLINE_DMA1_CH6                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA1_CH6) /*!< DMA1 Channel 6 Interrupt */
#define HAL_ITLINE_DMA1_CH7                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA1_CH7) /*!< DMA1 Channel 7 Interrupt */
#endif                                                             /* DMA1_Channel7 */
#if defined(DMA2)
#define HAL_ITLINE_DMA2_CH1                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA2_CH1) /*!< DMA2 Channel 1 Interrupt */
#define HAL_ITLINE_DMA2_CH2                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA2_CH2) /*!< DMA2 Channel 2 Interrupt */
#define HAL_ITLINE_DMA2_CH3                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA2_CH3) /*!< DMA2 Channel 3 Interrupt */
#define HAL_ITLINE_DMA2_CH4                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA2_CH4) /*!< DMA2 Channel 4 Interrupt */
#define HAL_ITLINE_DMA2_CH5                                                                                            \
    ((HAL_SYSCFG_ITLINE11 << 0x18U) | SYSCFG_ITLINE11_SR_DMA2_CH5)               /*!< DMA2 Channel 5 Interrupt */
#endif                                                                           /* DMA2 */
#define HAL_ITLINE_ADC ((HAL_SYSCFG_ITLINE12 << 0x18U) | SYSCFG_ITLINE12_SR_ADC) /*!< ADC Interrupt */
#if defined(COMP1)
#define HAL_ITLINE_COMP1                                                                                               \
    ((HAL_SYSCFG_ITLINE12 << 0x18U) | SYSCFG_ITLINE12_SR_COMP1) /*!< COMP1 Interrupt -> exti[17]                       \
                                                                 */
#endif                                                          /* COMP1 */
#if defined(COMP2)
#define HAL_ITLINE_COMP2                                                                                               \
    ((HAL_SYSCFG_ITLINE12 << 0x18U) | SYSCFG_ITLINE12_SR_COMP2) /*!< COMP2 Interrupt -> exti[18]                       \
                                                                 */
#endif                                                          /* COMP2 */
#if defined(COMP3)
#define HAL_ITLINE_COMP3                                                                                               \
    ((HAL_SYSCFG_ITLINE12 << 0x18U) | SYSCFG_ITLINE12_SR_COMP3) /*!< COMP3 Interrupt -> exti[1x]                       \
                                                                 */
#endif                                                          /* COMP3 */
...
#endif                                                                           /* DAC1 */
#if defined(LPTIM1)
#define HAL_ITLINE_LPTIM1                                                                                              \
    ((HAL_SYSCFG_ITLINE17 << 0x18U) | SYSCFG_ITLINE17_SR_LPTIM1_GLB) /*!< LPTIM1 Interrupt -> exti[29] */
#endif                                                               /* LPTIM1 */
#if defined(TIM7)
#define HAL_ITLINE_TIM7 ((HAL_SYSCFG_ITLINE18 << 0x18U) | SYSCFG_ITLINE18_SR_TIM7_GLB) /*!< TIM7 Interrupt */
#endif                                                                                 /* TIM7 */
#if defined(LPTIM2)
#define HAL_ITLINE_LPTIM2                                                                                              \
    ((HAL_SYSCFG_ITLINE18 << 0x18U) | SYSCFG_ITLINE18_SR_LPTIM2_GLB) /*!< LPTIM2 Interrupt -> exti[30] */
#endif                                                               /* LPTIM2 */
...
#define HAL_ITLINE_FDCAN1_IT0                                                                                          \
    ((HAL_SYSCFG_ITLINE21 << 0x18U) | SYSCFG_ITLINE21_SR_FDCAN1_IT0) /*!< FDCAN1_IT0 Interrupt */
#define HAL_ITLINE_FDCAN2_IT0                                                                                          \
    ((HAL_SYSCFG_ITLINE21 << 0x18U) | SYSCFG_ITLINE21_SR_FDCAN2_IT0)                     /*!< FDCAN2_IT0 Interrupt */
#endif                                                                                   /* FDCAN1 || FDCAN2 */
#define HAL_ITLINE_TIM17 ((HAL_SYSCFG_ITLINE22 << 0x18U) | SYSCFG_ITLINE22_SR_TIM17_GLB) /*!< TIM17 Interrupt */
#if defined(FDCAN1) || defined(FDCAN2)
#define HAL_ITLINE_FDCAN1_IT1                                                                                          \
    ((HAL_SYSCFG_ITLINE22 << 0x18U) | SYSCFG_ITLINE22_SR_FDCAN1_IT1) /*!< FDCAN1_IT1 Interrupt */
#define HAL_ITLINE_FDCAN2_IT1                                                                                          \
    ((HAL_SYSCFG_ITLINE22 << 0x18U) | SYSCFG_ITLINE22_SR_FDCAN2_IT1) /*!< FDCAN2_IT1 Interrupt */
#endif                                                               /* FDCAN1 || FDCAN2 */
#define HAL_ITLINE_I2C1                                                                                                \
    ((HAL_SYSCFG_ITLINE23 << 0x18U) | SYSCFG_ITLINE23_SR_I2C1_GLB) /*!< I2C1 Interrupt -> exti[23] */
#define HAL_ITLINE_I2C2                                                                                                \
    ((HAL_SYSCFG_ITLINE24 << 0x18U) | SYSCFG_ITLINE24_SR_I2C2_GLB) /*!< I2C2 Interrupt -> exti[24] */
#if defined(I2C3)
#define HAL_ITLINE_I2C3                                                                                                \
    ((HAL_SYSCFG_ITLINE24 << 0x18U) | SYSCFG_ITLINE24_SR_I2C3_GLB)                 /*!< I2C3 Interrupt -> exti[22] */
#endif                                                                             /* I2C3 */
...
#define HAL_ITLINE_USART1                                                                                              \
    ((HAL_SYSCFG_ITLINE27 << 0x18U) | SYSCFG_ITLINE27_SR_USART1_GLB) /*!< USART1 GLB Interrupt -> exti[25] */
#define HAL_ITLINE_USART2                                                                                              \
    ((HAL_SYSCFG_ITLINE28 << 0x18U) | SYSCFG_ITLINE28_SR_USART2_GLB) /*!< USART2 GLB Interrupt -> exti[26] */
#if defined(LPUART2)
#define HAL_ITLINE_LPUART2                                                                                             \
    ((HAL_SYSCFG_ITLINE28 << 0x18U) | SYSCFG_ITLINE28_SR_LPUART2_GLB) /*!< LPUART2 GLB Interrupt -> exti[26] */
#endif                                                                /* LPUART2 */
#if defined(USART3)
#define HAL_ITLINE_USART3                                                                                              \
    ((HAL_SYSCFG_ITLINE29 << 0x18U) | SYSCFG_ITLINE29_SR_USART3_GLB) /*!< USART3 Interrupt ....                        \
                                                                      */
#endif                                                               /* USART3 */
#if defined(USART4)
#define HAL_ITLINE_USART4                                                                                              \
    ((HAL_SYSCFG_ITLINE29 << 0x18U) | SYSCFG_ITLINE29_SR_USART4_GLB) /*!< USART4 Interrupt ....                        \
                                                                      */
#endif                                                               /* USART4 */
#if defined(LPUART1)
#define HAL_ITLINE_LPUART1                                                                                             \
    ((HAL_SYSCFG_ITLINE29 << 0x18U) | SYSCFG_ITLINE29_SR_LPUART1_GLB) /*!< LPUART1 Interrupt -> exti[28]*/
#endif                                                                /* LPUART1 */
#if defined(USART5)
#define HAL_ITLINE_USART5                                                                                              \
    ((HAL_SYSCFG_ITLINE29 << 0x18U) | SYSCFG_ITLINE29_SR_USART5_GLB) /*!< USART5 Interrupt ....                        \
                                                                      */
#endif                                                               /* USART5 */
#if defined(USART6)
#define HAL_ITLINE_USART6                                                                                              \
    ((HAL_SYSCFG_ITLINE29 << 0x18U) | SYSCFG_ITLINE29_SR_USART6_GLB) /*!< USART6 Interrupt ....                        \
                                                                      */
#endif                                                               /* USART6 */
#if defined(CEC)
 ...
 *         Enable and lock the connection of Flash ECC error connection to TIM1
 * Break input.
 ...
 *         Enables and locks the connection of Cortex-M0+ LOCKUP (Hardfault)
 * output to TIM1/15/16/17 Break input
 * @note   The selected configuration is locked and can be unlocked only by
 * system reset.
 */
 ...
 * input, as well as the PVDE and PLS[2:0] in the PWR_CR register
 * @note   The selected configuration is locked and can be unlocked only by
 * system reset
 */
 ...
 * TIMER1/15/16/17
 * @note   The selected configuration is locked and can only be unlocked by
 * system reset
 */
 ...
 * @param __FASTMODEPLUS__ This parameter can be a value of @ref
 * SYSCFG_FastModePlus_GPIO
 */
 ...
 * @param __PIN__ This parameter can be a combination of values @ref
 * SYSCFG_ClampingDiode
 */
#define __HAL_SYSCFG_CLAMPINGDIODE_ENABLE(__PIN__)                                                                     \
    do                                                                                                                 \
    {                                                                                                                  \
        assert_param(IS_SYSCFG_CLAMPINGDIODE((__PIN__)));                                                              \
        SET_BIT(SYSCFG->CFGR2, (__PIN__));                                                                             \
    } while (0U)

#define __HAL_SYSCFG_CLAMPINGDIODE_DISABLE(__PIN__)                                                                    \
    do                                                                                                                 \
    {                                                                                                                  \
        assert_param(IS_SYSCFG_CLAMPINGDIODE((__PIN__)));                                                              \
...
/** @brief  selection of the modulation envelope signal macro, using bits [7:6]
 * of SYSCFG_CFGR1 register
 ...
 */
#define __HAL_SYSCFG_IRDA_OUT_POLARITY_SELECTION(__SEL__)                                                              \
    do                                                                                                                 \
    {                                                                                                                  \
        assert_param(IS_HAL_SYSCFG_IRDA_POL_SEL((__SEL__)));                                                           \
 ...
 * @retval The IROut polarity as configured by user. The returned value can be
 * one of @ref HAL_IR_POL_SEL
 */
 ...
 */
#define __HAL_SYSCFG_BREAK_ENABLE(__BREAK__)                                                                           \
    do                                                                                                                 \
    {                                                                                                                  \
        assert_param(IS_SYSCFG_BREAK_CONFIG((__BREAK__)));                                                             \
        SET_BIT(SYSCFG->CFGR2, (__BREAK__));                                                                           \
    } while (0U)

#define __HAL_SYSCFG_BREAK_DISABLE(__BREAK__)                                                                          \
    do                                                                                                                 \
    {                                                                                                                  \
        assert_param(IS_SYSCFG_BREAK_CONFIG((__BREAK__)));                                                             \
...
#define IS_SYSCFG_BREAK_CONFIG(__CONFIG__)                                                                             \
    (((__CONFIG__) == SYSCFG_BREAK_SP) || ((__CONFIG__) == SYSCFG_BREAK_PVD) || ((__CONFIG__) == SYSCFG_BREAK_ECC) ||  \
     ((__CONFIG__) == SYSCFG_BREAK_LOCKUP))
#else
#define IS_SYSCFG_BREAK_CONFIG(__CONFIG__)                                                                             \
    (((__CONFIG__) == SYSCFG_BREAK_SP) || ((__CONFIG__) == SYSCFG_BREAK_ECC) || ((__CONFIG__) == SYSCFG_BREAK_LOCKUP))
#endif /* PWR_PVD_SUPPORT */

#if defined(SYSCFG_CDEN_SUPPORT)
#define IS_SYSCFG_CLAMPINGDIODE(__PIN__)                                                                               \
    ((((__PIN__) & SYSCFG_CDEN_PA1) == SYSCFG_CDEN_PA1) || (((__PIN__) & SYSCFG_CDEN_PA3) == SYSCFG_CDEN_PA3) ||       \
     (((__PIN__) & SYSCFG_CDEN_PA5) == SYSCFG_CDEN_PA5) || (((__PIN__) & SYSCFG_CDEN_PA6) == SYSCFG_CDEN_PA6) ||       \
     (((__PIN__) & SYSCFG_CDEN_PA13) == SYSCFG_CDEN_PA13) || (((__PIN__) & SYSCFG_CDEN_PB0) == SYSCFG_CDEN_PB0) ||     \
     (((__PIN__) & SYSCFG_CDEN_PB1) == SYSCFG_CDEN_PB1) || (((__PIN__) & SYSCFG_CDEN_PB2) == SYSCFG_CDEN_PB2))
#endif /* SYSCFG_CDEN_SUPPORT */

#if defined(USART4)
#define IS_HAL_SYSCFG_IRDA_ENV_SEL(SEL)                                                                                \
    (((SEL) == HAL_SYSCFG_IRDA_ENV_SEL_TIM16) || ((SEL) == HAL_SYSCFG_IRDA_ENV_SEL_USART1) ||                          \
...
#endif /* USART4 */
#define IS_HAL_SYSCFG_IRDA_POL_SEL(SEL)                                                                                \
    (((SEL) == HAL_SYSCFG_IRDA_POLARITY_NOT_INVERTED) || ((SEL) == HAL_SYSCFG_IRDA_POLARITY_INVERTED))

#if defined(SYSCFG_CFGR1_UCPD1_STROBE) || defined(SYSCFG_CFGR1_UCPD2_STROBE)
#define IS_SYSCFG_DBATT_CONFIG(__CONFIG__)                                                                             \
    (((__CONFIG__) == SYSCFG_UCPD1_STROBE) || ((__CONFIG__) == SYSCFG_UCPD2_STROBE) ||                                 \
...
#define IS_SYSCFG_VREFBUF_HIGH_IMPEDANCE(__VALUE__)                                                                    \
    (((__VALUE__) == SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE) || ((__VALUE__) == SYSCFG_VREFBUF_HIGH_IMPEDANCE_ENABLE))
...
#define IS_HAL_REMAP_PIN(RMP)                                                                                          \
    (((RMP) == SYSCFG_REMAP_PA11) || ((RMP) == SYSCFG_REMAP_PA12) || ((RMP) == (SYSCFG_REMAP_PA11 | SYSCFG_REMAP_PA12)))
/**
 * @}
 */
...
#define IS_TICKFREQ(FREQ)                                                                                              \
    ...
    /** @defgroup HAL_Exported_Functions_Group1 HAL Initialization and Configuration
     * functions
     * @{
     */
