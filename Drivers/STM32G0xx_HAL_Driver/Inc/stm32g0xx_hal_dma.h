...
#include "stm32g0xx_ll_dma.h"
    ...
    typedef struct
    {
        ...
        uint32_t Direction; /*!< Specifies if the data will be transferred from
                               memory to peripheral, from memory to memory or from
                               peripheral to memory. This parameter can be a value
                               of @ref DMA_Data_transfer_direction */
        ...
        uint32_t MemInc; /*!< Specifies whether the memory address register should
                            be incremented or not. This parameter can be a value of
                            @ref DMA_Memory_incremented_mode */
...
#define DMA_FLAG_TC1                                                                                                   \
    DMA_ISR_TCIF1                  /*!< Transfer Complete flag for Channel 1                                           \
                                    */
...
#define DMA_FLAG_TC2                                                                                                   \
    DMA_ISR_TCIF2                  /*!< Transfer Complete flag for Channel 2                                           \
                                    */
...
#define DMA_FLAG_TC3                                                                                                   \
    DMA_ISR_TCIF3                  /*!< Transfer Complete flag for Channel 3                                           \
                                    */
...
#define DMA_FLAG_TC4                                                                                                   \
    DMA_ISR_TCIF4                  /*!< Transfer Complete flag for Channel 4                                           \
                                    */
...
#define DMA_FLAG_TC5                                                                                                   \
    DMA_ISR_TCIF5                  /*!< Transfer Complete flag for Channel 5                                           \
                                    */
...
#define DMA_FLAG_TC6                                                                                                   \
    DMA_ISR_TCIF6                  /*!< Transfer Complete flag for Channel 6                                           \
                                    */
...
#define DMA_FLAG_TC7                                                                                                   \
    DMA_ISR_TCIF7                  /*!< Transfer Complete flag for Channel 7                                           \
                                    */
