...
#include "stm32g0xx_ll_dmamux.h"
    ...
    typedef struct
    {
        uint32_t SyncSignalID; /*!< Specifies the synchronization signal gating the DMA
                                 request in periodic mode. This parameter can be a value
                                 of @ref DMAEx_DMAMUX_SyncSignalID_selection */

        uint32_t SyncPolarity; /*!< Specifies the polarity of the signal on which the DMA
                                 request is synchronized. This parameter can be a value
                                 of @ref DMAEx_DMAMUX_SyncPolarity_selection */

        FunctionalState SyncEnable; /*!< Specifies if the synchronization shall be
                                      enabled or disabled This parameter can take
    ...
    typedef struct
    {
        uint32_t SignalID; /*!< Specifies the ID of the signal used for DMAMUX
                             request generator This parameter can be a value of @ref
                             DMAEx_DMAMUX_SignalGeneratorID_selection */

        uint32_t Polarity; /*!< Specifies the polarity of the signal on which the request
                             is generated. This parameter can be a value of @ref
                             DMAEx_DMAMUX_RequestGeneneratorPolarity_selection */
...
#define HAL_DMAMUX1_SYNC_EXTI13                                                                                        \
    LL_DMAMUX_SYNC_EXTI_LINE13 /*!< Synchronization signal from EXTI Line1 3                                           \
                                */
#define HAL_DMAMUX1_SYNC_EXTI14                                                                                        \
    LL_DMAMUX_SYNC_EXTI_LINE14 /*!< Synchronization signal from EXTI Line1 4                                           \
                                */
#define HAL_DMAMUX1_SYNC_EXTI15                                                                                        \
    LL_DMAMUX_SYNC_EXTI_LINE15 /*!< Synchronization signal from EXTI Line1 5                                           \
                                */
...
#define HAL_DMAMUX1_SYNC_DMAMUX1_CH2_EVT                                                                               \
    LL_DMAMUX_SYNC_DMAMUX_CH2 /*!< Synchronization signal from DMAMUX channel2                                         \
                                 Event */
#define HAL_DMAMUX1_SYNC_DMAMUX1_CH3_EVT                                                                               \
    LL_DMAMUX_SYNC_DMAMUX_CH3 /*!< Synchronization signal from DMAMUX channel3                                         \
                                 Event */
#if defined(LPTIM1)
...
#define HAL_DMAMUX1_REQ_GEN_EXTI0                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE0 /*!< Request signal generation from EXTI                                              \
                                    Line0  */
#define HAL_DMAMUX1_REQ_GEN_EXTI1                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE1 /*!< Request signal generation from EXTI                                              \
                                    Line1  */
#define HAL_DMAMUX1_REQ_GEN_EXTI2                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE2 /*!< Request signal generation from EXTI                                              \
                                    Line2  */
#define HAL_DMAMUX1_REQ_GEN_EXTI3                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE3 /*!< Request signal generation from EXTI                                              \
                                    Line3  */
#define HAL_DMAMUX1_REQ_GEN_EXTI4                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE4 /*!< Request signal generation from EXTI                                              \
                                    Line4  */
#define HAL_DMAMUX1_REQ_GEN_EXTI5                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE5 /*!< Request signal generation from EXTI                                              \
                                    Line5  */
#define HAL_DMAMUX1_REQ_GEN_EXTI6                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE6 /*!< Request signal generation from EXTI                                              \
                                    Line6  */
#define HAL_DMAMUX1_REQ_GEN_EXTI7                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE7 /*!< Request signal generation from EXTI                                              \
                                    Line7  */
#define HAL_DMAMUX1_REQ_GEN_EXTI8                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE8 /*!< Request signal generation from EXTI                                              \
                                    Line8  */
#define HAL_DMAMUX1_REQ_GEN_EXTI9                                                                                      \
    LL_DMAMUX_REQ_GEN_EXTI_LINE9 /*!< Request signal generation from EXTI                                              \
                                    Line9  */
...
#define HAL_DMAMUX1_REQ_GEN_DMAMUX1_CH2_EVT                                                                            \
    LL_DMAMUX_REQ_GEN_DMAMUX_CH2 /*!< Request signal generation from DMAMUX                                            \
                                    channel2 Event */
#define HAL_DMAMUX1_REQ_GEN_DMAMUX1_CH3_EVT                                                                            \
    LL_DMAMUX_REQ_GEN_DMAMUX_CH3 /*!< Request signal generation from DMAMUX                                            \
                                    channel3 Event */
#if defined(LPTIM1)
...
#define HAL_DMAMUX_REQ_GEN_RISING_FALLING                                                                              \
    ...
    HAL_StatusTypeDef HAL_DMAEx_ConfigMuxRequestGenerator(
        DMA_HandleTypeDef *hdma, const HAL_DMA_MuxRequestGeneratorConfigTypeDef *pRequestGeneratorConfig);
...
#define IS_DMAMUX_SYNC_SIGNAL_ID(SIGNAL_ID)                                                                            \
    (((SIGNAL_ID) == HAL_DMAMUX1_SYNC_EXTI0) ||                                                                        \
     (((SIGNAL_ID) >= HAL_DMAMUX1_SYNC_EXTI1) && ((SIGNAL_ID) <= HAL_DMAMUX1_MAX_SYNC)))
...
#define IS_DMAMUX_REQUEST_GEN_SIGNAL_ID(SIGNAL_ID)                                                                     \
    (((SIGNAL_ID) == HAL_DMAMUX1_REQ_GEN_EXTI0) ||                                                                     \
     (((SIGNAL_ID) >= HAL_DMAMUX1_REQ_GEN_EXTI1) && ((SIGNAL_ID) <= HAL_DMAMUX1_MAX_REQ_GEN)))
