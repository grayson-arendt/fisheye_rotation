...
#include "stm32g0xx_hal_def.h"
    ...
    typedef struct
    {
        ...
        uint32_t Page;      /*!< Initial Flash page to erase when page erase is enabled
                                 This parameter must be a value between 0 and
                               (FLASH_PAGE_NB - 1) */
        uint32_t NbPages;   /*!< Number of pages to be erased.
                                 This parameter must be a value between 1 and
                               (FLASH_PAGE_NB - value of initial page)*/
    ...
    typedef struct
    {
        uint32_t OptionType;     /*!< Option byte to be configured.
                                      This parameter can be a combination of the values
        ...
        uint32_t WRPStartOffset; /*!< Write protection start offset (used for
                                    ...
                                    between 0 and [FLASH_PAGE_NB - 1]*/
        uint32_t WRPEndOffset;   /*!< Write protection end offset (used for
                                    OPTIONBYTE_WRP).   This parameter must be a value
                                    between WRPStartOffset and [FLASH_PAGE_NB - 1] */
        uint32_t RDPLevel;       /*!< Set the read protection level (used for
                                    OPTIONBYTE_RDP).       This parameter can be a value
                                    of @ref       FLASH_OB_Read_Protection */
        ...
        uint32_t PCROPConfig;      /*!< Configuration of the PCROP (used for
                                      ...
                                      combination of @ref FLASH_OB_PCROP_ZONE and @ref
                                      FLASH_OB_PCROP_RDP. Note that once set, Pcrop erase
                                      on RDP level 1 regression (PCROP_RDP bit) can not
                                      be reset. It will be reset by mass erase */
        uint32_t PCROP1AStartAddr; /*!< PCROP Start address (used for OPTIONBYTE_PCROP).
                                      It represents first address of start block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        uint32_t PCROP1AEndAddr;   /*!< PCROP End address (used for OPTIONBYTE_PCROP).
                                      It represents first address of end block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        uint32_t PCROP1BStartAddr; /*!< PCROP Start address (used for OPTIONBYTE_PCROP).
                                      It represents first address of start block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        uint32_t PCROP1BEndAddr;   /*!< PCROP End address (used for OPTIONBYTE_PCROP).
                                      It represents first address of end block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
#if defined(FLASH_DBANK_SUPPORT)
        uint32_t PCROP2AStartAddr; /*!< PCROP Start address (used for OPTIONBYTE_PCROP).
                                      It represents first address of start block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        uint32_t PCROP2AEndAddr;   /*!< PCROP End address (used for OPTIONBYTE_PCROP).
                                      It represents first address of end block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        uint32_t PCROP2BStartAddr; /*!< PCROP Start address (used for OPTIONBYTE_PCROP).
                                      It represents first address of start block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        uint32_t PCROP2BEndAddr;   /*!< PCROP End address (used for OPTIONBYTE_PCROP).
                                      It represents first address of end block to
                                      protect. Make sure this parameter is multiple of
                                      PCROP granularity: 512 Bytes.*/
        ...
        uint32_t BootEntryPoint; /*!< Allow to force a unique boot entry point to
                                    Flash or system Flash */
        uint32_t SecSize;        /*!< This parameter defines securable memory area width in
                                    number of pages starting from Flash base address. This
                                    parameter must be a value between [0] and
                                    [FLASH_PAGE_NB], [0] meaning no secure area defined,
                                    [1] meaning first page only protected, etc... */
#if defined(FLASH_DBANK_SUPPORT)
        uint32_t SecSize2; /*!< This parameter defines securable memory area width in
                              number of pages starting from 2nd Bank start address. This
                              parameter must be a value between [0] and [FLASH_PAGE_NB],
                               [0] meaning no secure area defined, [1] meaning first page
                              only protected, etc... */
    ...
    typedef struct
    {
        ...
        uint32_t Address;          /* Internal variable to save address selected for program
                                      in IT context */
        uint32_t Banks;            /* Internal variable to save current bank selected during
                                      erase in IT context */
        uint32_t Page;             /* Internal variable to define the current page which is
                                      erasing in IT context */
        uint32_t NbPagesToErase;   /* Internal variable to save the remaining pages to
                                      erase in IT context */
...
#define FLASH_FLAG_EOP                                                                                                 \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_EOP_Pos) /*!< FLASH End of operation flag                     \
                                                                   */
#define FLASH_FLAG_OPERR                                                                                               \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_OPERR_Pos) /*!< FLASH Operation error flag */
#define FLASH_FLAG_PROGERR                                                                                             \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_PROGERR_Pos) /*!< FLASH Programming error flag */
#define FLASH_FLAG_WRPERR                                                                                              \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_WRPERR_Pos) /*!< FLASH Write protection error flag */
#define FLASH_FLAG_PGAERR                                                                                              \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_PGAERR_Pos) /*!< FLASH Programming alignment error flag */
#define FLASH_FLAG_SIZERR                                                                                              \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_SIZERR_Pos) /*!< FLASH Size error flag  */
#define FLASH_FLAG_PGSERR                                                                                              \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_PGSERR_Pos) /*!< FLASH Programming sequence error flag */
#define FLASH_FLAG_MISERR                                                                                              \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_MISERR_Pos) /*!< FLASH Fast programming data miss error flag  \
                                                                      */
#define FLASH_FLAG_FASTERR                                                                                             \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_FASTERR_Pos) /*!< FLASH Fast programming error flag */
#if defined(FLASH_PCROP_SUPPORT)
#define FLASH_FLAG_RDERR                                                                                               \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_RDERR_Pos) /*!< FLASH PCROP read error flag */
#endif                                                              /* FLASH_PCROP_SUPPORT */
#define FLASH_FLAG_OPTVERR                                                                                             \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_OPTVERR_Pos) /*!< FLASH Option validity error flag */
#define FLASH_FLAG_BSY1                                                                                                \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_BSY1_Pos) /*!< FLASH Operation Busy flag for Bank 1 */
#if defined(FLASH_DBANK_SUPPORT)
#define FLASH_FLAG_BSY2                                                                                                \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_BSY2_Pos) /*!< FLASH Operation Busy flag for Bank 2 */
#endif                                                             /* FLASH_DBANK_SUPPORT */
#define FLASH_FLAG_BSY                                                                                                 \
    FLASH_FLAG_BSY1 /*!< FLASH Operation Busy flag - legacy name for single                                            \
                       bank */
#define FLASH_FLAG_CFGBSY                                                                                              \
    ((FLASH_FLAG_SR_ID << FLASH_FLAG_REG_POS) | FLASH_SR_CFGBSY_Pos) /*!< FLASH Configuration Busy flag */
#define FLASH_FLAG_ECCC1                                                                                               \
    ((FLASH_FLAG_ECCR1_ID << FLASH_FLAG_REG_POS) | FLASH_ECCR_ECCC_Pos) /*!< FLASH ECC correction on bank 1 */
#define FLASH_FLAG_ECCD1                                                                                               \
    ((FLASH_FLAG_ECCR1_ID << FLASH_FLAG_REG_POS) | FLASH_ECCR_ECCD_Pos) /*!< FLASH ECC detection on bank 1 */
#if defined(FLASH_DBANK_SUPPORT)
#define FLASH_FLAG_ECCC2                                                                                               \
    ((FLASH_FLAG_ECCR2_ID << FLASH_FLAG_REG_POS) | FLASH_ECC2R_ECCC_Pos) /*!< FLASH ECC correction on bank 2 */
#define FLASH_FLAG_ECCD2                                                                                               \
    ((FLASH_FLAG_ECCR2_ID << FLASH_FLAG_REG_POS) | FLASH_ECC2R_ECCD_Pos) /*!< FLASH ECC detection on bank 2 */
#endif                                                                   /* FLASH_DBANK_SUPPORT */
#define FLASH_FLAG_ECCC                                                                                                \
    FLASH_FLAG_ECCC1                     /*!< FLASH ECC correction - legacy name for single bank                       \
                                          */
 ...
 */
#define FLASH_IT_EOP                                                                                                   \
    ((FLASH_FLAG_CR_ID << FLASH_FLAG_REG_POS) | FLASH_CR_EOPIE_Pos) /*!< End of FLASH Operation Interrupt source */
#define FLASH_IT_OPERR ((FLASH_FLAG_CR_ID << FLASH_FLAG_REG_POS) | FLASH_CR_ERRIE_Pos) /*!< Error Interrupt source */
#if defined(FLASH_PCROP_SUPPORT)
#define FLASH_IT_RDERR                                                                                                 \
    ((FLASH_FLAG_CR_ID << FLASH_FLAG_REG_POS) | FLASH_CR_RDERRIE_Pos) /*!< PCROP Read Error Interrupt source*/
#endif                                                                /* FLASH_PCROP_SUPPORT */
#define FLASH_IT_ECCC1                                                                                                 \
    ((FLASH_FLAG_ECCR1_ID << FLASH_FLAG_REG_POS) |                                                                     \
     FLASH_ECCR_ECCCIE_Pos) /*!< ECC Correction on Bank 1 Interrupt source */
#if defined(FLASH_DBANK_SUPPORT)
#define FLASH_IT_ECCC2                                                                                                 \
    ((FLASH_FLAG_ECCR2_ID << FLASH_FLAG_REG_POS) |                                                                     \
     FLASH_ECC2R_ECCCIE_Pos)         /*!< ECC Correction on Bank 2 Interrupt source */
#endif                               /* FLASH_DBANK_SUPPORT */
...
#define FLASH_TYPEPROGRAM_FAST                                                                                         \
    FLASH_CR_FSTPG /*!< Fast program a 32 row double-word (64-bit) at a                                                \
                      specified address */
/**
 * @}
 */
...
#define OPTIONBYTE_ALL                                                                                                 \
    (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP |                                            \
     OPTIONBYTE_SEC) /*!< All option byte configuration */
#else
...
#define OB_RDP_LEVEL_2                                                                                                 \
    0x000000CCU /*!< Warning: When enabling read protection level 2                                                    \
...
#define OB_USER_nRST_STDBY                                                                                             \
    FLASH_OPTR_nRST_STDBY /*!< Reset generated when entering the standby mode                                          \
                           */
#if defined(PWR_SHDW_SUPPORT)
#define OB_USER_nRST_SHDW                                                                                              \
    FLASH_OPTR_nRST_SHDW                   /*!< Reset generated when entering the shutdown mode                        \
                                            */
...
#define OB_USER_IWDG_STDBY                                                                                             \
    FLASH_OPTR_IWDG_STDBY                  /*!< Independent watchdog counter freeze in standby                         \
                                              mode */
...
#define OB_USER_DUAL_BANK                                                                                              \
    FLASH_OPTR_DUAL_BANK                                     /*!< Select single or dual bank (depending of device      \
                                                                memory size) */
#endif                                                       /* FLASH_DBANK_SUPPORT */
...
#define OB_USER_ALL                                                                                                    \
    (OB_USER_BOR_EN | OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_nRST_SHDW | OB_USER_IWDG_SW | \
     OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_WWDG_SW | OB_USER_BANK_SWAP | OB_USER_DUAL_BANK |                \
     OB_USER_RAM_PARITY_CHECK | OB_USER_nBOOT_SEL | OB_USER_nBOOT1 | OB_USER_nBOOT0 | OB_USER_NRST_MODE |              \
     OB_USER_INPUT_RESET_HOLDER) /*!< all option bits */
#else
#define OB_USER_ALL                                                                                                    \
    (OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_IWDG_SW | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY |               \
     OB_USER_WWDG_SW | OB_USER_BANK_SWAP | OB_USER_DUAL_BANK | OB_USER_RAM_PARITY_CHECK | OB_USER_nBOOT_SEL |          \
     OB_USER_nBOOT1 | OB_USER_nBOOT0) /*!< all option bits */
#endif                                /* PWR_BOR_SUPPORT && PWR_SHDW_SUPPORT && GPIO_NRST_CONFIG_SUPPORT */
#else
#if defined(PWR_BOR_SUPPORT) && defined(PWR_SHDW_SUPPORT) && defined(GPIO_NRST_CONFIG_SUPPORT)
#define OB_USER_ALL                                                                                                    \
    (OB_USER_BOR_EN | OB_USER_BOR_LEV | OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_nRST_SHDW | OB_USER_IWDG_SW | \
     OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | OB_USER_WWDG_SW | OB_USER_RAM_PARITY_CHECK | OB_USER_nBOOT_SEL |         \
     OB_USER_nBOOT1 | OB_USER_nBOOT0 | OB_USER_NRST_MODE | OB_USER_INPUT_RESET_HOLDER) /*!< all option bits */
#else
#define OB_USER_ALL                                                                                                    \
    (OB_USER_nRST_STOP | OB_USER_nRST_STDBY | OB_USER_IWDG_SW | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY |               \
     OB_USER_WWDG_SW | OB_USER_RAM_PARITY_CHECK | OB_USER_nBOOT_SEL | OB_USER_nBOOT1 |                                 \
...
#define OB_BOR_LEVEL_FALLING_1                                                                                         \
    FLASH_OPTR_BORF_LEV_0 /*!< BOR falling level 2 with threshold around 2.2V                                          \
                           */
#define OB_BOR_LEVEL_FALLING_2                                                                                         \
    FLASH_OPTR_BORF_LEV_1 /*!< BOR falling level 3 with threshold around 2.5V                                          \
                           */
#define OB_BOR_LEVEL_FALLING_3                                                                                         \
    (FLASH_OPTR_BORF_LEV_0 | FLASH_OPTR_BORF_LEV_1) /*!< BOR falling level 4 with threshold                            \
                                                       around 2.8V */
#define OB_BOR_LEVEL_RISING_0 0x00000000U           /*!< BOR rising level 1 with threshold around 2.1V */
#define OB_BOR_LEVEL_RISING_1                                                                                          \
    FLASH_OPTR_BORR_LEV_0 /*!< BOR rising level 2 with threshold around 2.3V                                           \
                           */
#define OB_BOR_LEVEL_RISING_2                                                                                          \
    FLASH_OPTR_BORR_LEV_1 /*!< BOR rising level 3 with threshold around 2.6V                                           \
                           */
#define OB_BOR_LEVEL_RISING_3                                                                                          \
    (FLASH_OPTR_BORR_LEV_0 | FLASH_OPTR_BORR_LEV_1) /*!< BOR rising level 4 with threshold around 2.9V                 \
                                                     */
/**
 * @}
 */
...
#define OB_STANDBY_NORST                                                                                               \
    FLASH_OPTR_nRST_STDBY /*!< No reset generated when entering the standby                                            \
                             mode */
    /**
     * @}
     */
...
#define OB_SHUTDOWN_NORST                                                                                              \
    FLASH_OPTR_nRST_SHDW /*!< No reset generated when entering the shutdown                                            \
                            mode */
/**
 * @}
 */
...
/** @defgroup FLASH_OB_USER_DUAL_BANK FLASH Option Bytes User dual bank enable
 * Type
 * @{
 */
...
#define OB_BOOT1_SRAM                                                                                                  \
    0x00000000U /*!< Embedded SRAM is selected as boot space (if nBOOT0=0 or                                           \
                   BOOT0_pin=1) */
#define OB_BOOT1_SYSTEM                                                                                                \
    FLASH_OPTR_nBOOT1 /*!< System memory is selected as boot space (if                                                 \
                         nBOOT0=0 or BOOT0_pin=1) */
/**
 * @}
 */
...
#if defined(GPIO_NRST_CONFIG_SUPPORT)
/** @defgroup FLASH_OB_USER_RESET_CONFIG FLASH Option Bytes User reset config
 * bit
 * @{
 */
...
#if defined(FLASH_OPTR_IRHEN)
/** @defgroup FLASH_OB_USER_INPUT_RESET_HOLDER FLASH Option Bytes User input
 * reset holder bit
 * @{
 */
...
#define OB_PCROP_RDP_ERASE                                                                                             \
    FLASH_PCROP1AER_PCROP_RDP /*!< PCROP area is erased when the RDP level is                                          \
                                   decreased from Level 1 to Level 0 (full                                             \
                                 mass erase). Once this bit is set only, it                                            \
                                 will be reset by mass erase */
/**
 * @}
 */
#endif /* FLASH_PCROP_SUPPORT */
 ...
 *     @arg @ref FLASH_IT_ECCC ECC Correction Interrupt - legacy name for single
 * bank
 * @note (*) availability depends on devices
 * @retval none
 */
...
#define __HAL_FLASH_ENABLE_IT(__INTERRUPT__)                                                                           \
    ...
    {                                                                                                                  \
        ...
        else if (((__INTERRUPT__) & (FLASH_FLAG_ECCR2_ID << FLASH_FLAG_REG_POS)) != 0U)                                \
        {                                                                                                              \
            SET_BIT(FLASH->ECC2R, (1uL << ((__INTERRUPT__) & 0x1Fu)));                                                 \
        }                                                                                                              \
    } while (0U)
#else
#define __HAL_FLASH_ENABLE_IT(__INTERRUPT__)                                                                           \
...
#define __HAL_FLASH_DISABLE_IT(__INTERRUPT__)                                                                          \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            CLEAR_BIT(FLASH->ECC2R, (1uL << ((__INTERRUPT__) & 0x1Fu)));                                               \
        }                                                                                                              \
    } while (0U)
#else
#define __HAL_FLASH_DISABLE_IT(__INTERRUPT__)                                                                          \
 ...
 *     @arg @ref FLASH_FLAG_BSY1 FLASH bank 1 write/erase operations in progress
 * flag
 *     @arg @ref FLASH_FLAG_BSY2 FLASH bank 2 write/erase operations in progress
 * flag(*)
 *     @arg @ref FLASH_FLAG_BSY FLASH write/erase operations in progress flag  -
 * legacy name for single bank
 *     @arg @ref FLASH_FLAG_CFGBSY FLASH configuration is busy : program or
 * erase setting are used.
 *     @arg @ref FLASH_FLAG_ECCC1 FLASH one ECC error has been detected and
 * corrected
 *     @arg @ref FLASH_FLAG_ECCD1 FLASH two ECC errors have been detected on
 * bank 1
 *     @arg @ref FLASH_FLAG_ECCC2 FLASH one ECC error has been detected and
 * corrected on bank 2(*)
 *     @arg @ref FLASH_FLAG_ECCD2 FLASH two ECC errors have been detected on
 * bank 2(*)
 *     @arg @ref FLASH_FLAG_ECCC FLASH one ECC error has been detected and
 * corrected - legacy name for single bank
...
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__)                                                                               \
    ...
    {                                                                                                                  \
        ...
        else if (((__FLAG__) & (FLASH_FLAG_ECCR2_ID << FLASH_FLAG_REG_POS)) != 0U)                                     \
        {                                                                                                              \
            FLASH->ECC2R |= (1uL << ((__FLAG__) & 0x1Fu));                                                             \
        }                                                                                                              \
    } while (0U)
#else
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__)                                                                               \
...
#if defined(FLASH_DBANK_SUPPORT)
#define OB_DUAL_BANK_BASE                                                                                              \
    (FLASH_R_BASE + 0x20U) /*!< Not use cmsis FLASH alias to avoid iar warning                                         \
                              about volatile reading sequence */
...
#define FLASH_BANK_NB                                                                                                  \
    (((FLASH_SALES_VALUE == 0U) || ((FLASH_SALES_VALUE == FLASH_SALES_TYPE_0) && (OB_DUAL_BANK_VALUE == 0U))) ? 1U : 2U)
#define FLASH_BANK_SIZE                                                                                                \
    ((FLASH_BANK_NB == 1U) ? (FLASH_SIZE) : (FLASH_SIZE >> 1U)) /*!< FLASH Bank Size. Divided by 2 if 2 Banks */
...
#define FLASH_SR_ERRORS                                                                                                \
    (FLASH_SR_OPERR | FLASH_SR_PROGERR | FLASH_SR_WRPERR | FLASH_SR_PGAERR | FLASH_SR_SIZERR | FLASH_SR_PGSERR |       \
     FLASH_SR_MISERR | FLASH_SR_FASTERR | FLASH_SR_RDERR | FLASH_SR_OPTVERR) /*!< All SR error flags */
#else
#define FLASH_SR_ERRORS                                                                                                \
    (FLASH_SR_OPERR | FLASH_SR_PROGERR | FLASH_SR_WRPERR | FLASH_SR_PGAERR | FLASH_SR_SIZERR | FLASH_SR_PGSERR |       \
 ...
 *  @{
 */
#define IS_FLASH_MAIN_MEM_ADDRESS(__ADDRESS__)                                                                         \
    (((__ADDRESS__) >= (FLASH_BASE)) && ((__ADDRESS__) <= (FLASH_BASE + FLASH_SIZE - 1UL)))

#define IS_FLASH_MAIN_FIRSTHALF_MEM_ADDRESS(__ADDRESS__)                                                               \
    (((__ADDRESS__) >= (FLASH_BASE)) && ((__ADDRESS__) <= (FLASH_BASE + FLASH_BANK_SIZE - 1UL)))
#if defined(FLASH_DBANK_SUPPORT)
#define IS_FLASH_MAIN_SECONDHALF_MEM_ADDRESS(__ADDRESS__)                                                              \
    (((__ADDRESS__) >= (FLASH_BASE + FLASH_BANK_SIZE)) && ((__ADDRESS__) <= (FLASH_BASE + FLASH_SIZE - 1UL)))
#endif /* FLASH_DBANK_SUPPORT */

#define IS_FLASH_PROGRAM_MAIN_MEM_ADDRESS(__ADDRESS__)                                                                 \
    (((__ADDRESS__) >= (FLASH_BASE)) && ((__ADDRESS__) <= (FLASH_BASE + FLASH_SIZE - 8UL)))

#define IS_FLASH_PROGRAM_OTP_ADDRESS(__ADDRESS__)                                                                      \
    (((__ADDRESS__) >= 0x1FFF7000U) && ((__ADDRESS__) <= (0x1FFF7400U - 8UL)))

#define IS_FLASH_PROGRAM_ADDRESS(__ADDRESS__)                                                                          \
    ((IS_FLASH_PROGRAM_MAIN_MEM_ADDRESS(__ADDRESS__)) || (IS_FLASH_PROGRAM_OTP_ADDRESS(__ADDRESS__)))

#define IS_FLASH_FAST_PROGRAM_ADDRESS(__ADDRESS__)                                                                     \
    (((__ADDRESS__) >= (FLASH_BASE)) && ((__ADDRESS__) <= (FLASH_BASE + FLASH_SIZE - 256UL)))

#define IS_FLASH_PAGE(__PAGE__) ((__PAGE__) < FLASH_PAGE_NB)

#if defined(FLASH_DBANK_SUPPORT)
#define IS_FLASH_BANK(__BANK__)                                                                                        \
    ((FLASH_BANK_NB == 2U) ? (((__BANK__) == FLASH_BANK_1) || ((__BANK__) == FLASH_BANK_2) ||                          \
...
#define IS_FLASH_TYPEERASE(__VALUE__) (((__VALUE__) == FLASH_TYPEERASE_PAGES) || ((__VALUE__) == FLASH_TYPEERASE_MASS))

#define IS_FLASH_TYPEPROGRAM(__VALUE__)                                                                                \
    (((__VALUE__) == FLASH_TYPEPROGRAM_DOUBLEWORD) || ((__VALUE__) == FLASH_TYPEPROGRAM_FAST))

#define IS_OPTIONBYTE(__VALUE__)                                                                                       \
    ((((__VALUE__) & OPTIONBYTE_ALL) != 0x00U) && (((__VALUE__) & ~OPTIONBYTE_ALL) == 0x00U))
...
#define IS_OB_RDP_LEVEL(__LEVEL__)                                                                                     \
    (((__LEVEL__) == OB_RDP_LEVEL_0) || ((__LEVEL__) == OB_RDP_LEVEL_1) || ((__LEVEL__) == OB_RDP_LEVEL_2))

#define IS_OB_USER_TYPE(__TYPE__) ((((__TYPE__) & OB_USER_ALL) != 0x00U) && (((__TYPE__) & ~OB_USER_ALL) == 0x00U))
...
#define IS_OB_PCROP_CONFIG(__CONFIG__)                                                                                 \
    ((FLASH_BANK_NB == 2U) ? (((__CONFIG__) & ~(OB_PCROP_ZONE_A | OB_PCROP_ZONE_B | OB_PCROP_ZONE2_A |                 \
                                                OB_PCROP_ZONE2_B | OB_PCROP_RDP_ERASE)) == 0x00U)                      \
...
#if defined(FLASH_SECURABLE_MEMORY_SUPPORT)
#define IS_OB_SEC_BOOT_LOCK(__VALUE__)                                                                                 \
    (((__VALUE__) == OB_BOOT_ENTRY_FORCED_NONE) || ((__VALUE__) == OB_BOOT_ENTRY_FORCED_FLASH))
