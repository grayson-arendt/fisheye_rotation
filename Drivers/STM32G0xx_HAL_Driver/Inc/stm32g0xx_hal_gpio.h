...
#define GPIO_MODE_IT_RISING                                                                                            \
    (MODE_INPUT | EXTI_IT | TRIGGER_RISING) /*!< External Interrupt Mode with Rising edge trigger                      \
                                               detection         */
#define GPIO_MODE_IT_FALLING                                                                                           \
    (MODE_INPUT | EXTI_IT | TRIGGER_FALLING) /*!< External Interrupt Mode with Falling edge trigger                    \
                                                detection        */
#define GPIO_MODE_IT_RISING_FALLING                                                                                    \
    (MODE_INPUT | EXTI_IT | TRIGGER_RISING | TRIGGER_FALLING) /*!< External Interrupt Mode with Rising/Falling edge    \
                                                                 trigger detection */
#define GPIO_MODE_EVT_RISING                                                                                           \
    (MODE_INPUT | EXTI_EVT | TRIGGER_RISING) /*!< External Event Mode with Rising edge trigger                         \
                                                detection             */
#define GPIO_MODE_EVT_FALLING                                                                                          \
    (MODE_INPUT | EXTI_EVT | TRIGGER_FALLING) /*!< External Event Mode with Falling edge trigger                       \
                                                 detection            */
#define GPIO_MODE_EVT_RISING_FALLING                                                                                   \
    (MODE_INPUT | EXTI_EVT | TRIGGER_RISING | TRIGGER_FALLING) /*!< External Event Mode with Rising/Falling edge       \
                                                                  trigger detection     */
/**
 * @}
 */
...
/**
 * @brief  Check whether the specified EXTI line is falling edge asserted or
 * not.
 * @param  __EXTI_LINE__ specifies the EXTI line to check.
 *          This parameter can be GPIO_PIN_x where x can be(0..15)
 * @retval The new state of __EXTI_LINE__ (SET or RESET).
...
#define IS_GPIO_MODE(__MODE__)                                                                                         \
    (((__MODE__) == GPIO_MODE_INPUT) || ((__MODE__) == GPIO_MODE_OUTPUT_PP) || ((__MODE__) == GPIO_MODE_OUTPUT_OD) ||  \
     ((__MODE__) == GPIO_MODE_AF_PP) || ((__MODE__) == GPIO_MODE_AF_OD) || ((__MODE__) == GPIO_MODE_IT_RISING) ||      \
     ((__MODE__) == GPIO_MODE_IT_FALLING) || ((__MODE__) == GPIO_MODE_IT_RISING_FALLING) ||                            \
