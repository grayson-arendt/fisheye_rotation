...
#include "stm32g0xx_hal_def.h"
    ...
    typedef struct
    {
        ...
        uint32_t ReloadValue; /*!< Specifies the value to be loaded in the frequency
                                 error counter with each SYNC event. It can be
                                 calculated in using macro
                                 __HAL_RCC_CRS_RELOADVALUE_CALCULATE(__FTARGET__,
                                 __FSYNC__) This parameter must be a number between
                                 0 and 0xFFFF or a value of @ref
        ...
        uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value
                                           to the HSI48 oscillator. This parameter must
                                           be a number between 0 and 0x7F or a value of
    ...
    typedef struct
    {
        uint32_t ReloadValue; /*!< Specifies the value loaded in the Counter reload
                                 value. This parameter must be a number between 0
                                 and 0xFFFF */

        uint32_t HSI48CalibrationValue; /*!< Specifies value loaded in HSI48 oscillator
                                           smooth trimming. This parameter must be a
                                           number between 0 and 0x7F */

        uint32_t FreqErrorCapture; /*!< Specifies the value loaded in the .FECAP, the
                                      frequency error counter value latched in the time
                                      of the last SYNC event. This parameter must be a
        ...
        uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the
                                        ...
                                        above the target. This parameter must be a value
                                        of @ref RCCEx_CRS_FreqErrorDirection*/
...
#define RCC_USART1CLKSOURCE_LSE                                                                                        \
    (RCC_CCIPR_USART1SEL_0 | RCC_CCIPR_USART1SEL_1) /*!< LSE clock selected as USART1 clock */
    /**
     * @}
     */
...
#define RCC_USART2CLKSOURCE_LSE                                                                                        \
    (RCC_CCIPR_USART2SEL_0 | RCC_CCIPR_USART2SEL_1) /*!< LSE clock selected as USART2 clock */
/**
 * @}
 */
#endif /* RCC_CCIPR_USART2SEL */
...
#define RCC_USART3CLKSOURCE_LSE                                                                                        \
    (RCC_CCIPR_USART3SEL_0 | RCC_CCIPR_USART3SEL_1) /*!< LSE clock selected as USART3 clock */
/**
 * @}
 */
#endif /* RCC_CCIPR_USART3SEL */
...
#define RCC_LPUART1CLKSOURCE_LSE                                                                                       \
    (RCC_CCIPR_LPUART1SEL_0 | RCC_CCIPR_LPUART1SEL_1) /*!< LSE clock selected as LPUART1 clock */
/**
 * @}
 */
#endif /* LPUART1 */
...
#define RCC_LPUART2CLKSOURCE_LSE                                                                                       \
    (RCC_CCIPR_LPUART2SEL_0 | RCC_CCIPR_LPUART2SEL_1) /*!< LSE clock selected as LPUART2 clock */
/**
 * @}
 */
#endif /* LPUART2 */
...
#define RCC_I2S1CLKSOURCE_EXT                                                                                          \
    RCC_CCIPR2_I2S1SEL /*!< External I2S clock source selected as I2S1 clock                                           \
                        */
#else
#define RCC_I2S1CLKSOURCE_SYSCLK 0x00000000U      /*!< SYSCLK clock selected as I2S1 clock */
...
#define RCC_I2S2CLKSOURCE_EXT                                                                                          \
    RCC_CCIPR2_I2S2SEL /*!< External I2S clock source selected as I2S2 clock                                           \
                        */
/**
 * @}
 */
...
#define RCC_RNGCLKSOURCE_HSI_DIV8                                                                                      \
 ...
 * @{
 */
#define RCC_CECCLKSOURCE_HSI_DIV488                                                                                    \
    0x00000000U                               /*!< HSI oscillator clock divided by 488 used as default CEC             \
                                                 clock */
...
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                                               \
    0x00000040U /*!< The default value is 64, which corresponds to the middle                                          \
                   of the trimming interval. The trimming step is specified in                                         \
                   the product datasheet. A higher TRIM value corresponds to a                                         \
...
#define RCC_CRS_FREQERRORDIR_DOWN                                                                                      \
    CRS_ISR_FEDIR /*!< Downcounting direction, the actual frequency is below                                           \
                     the target */
/**
 * @}
 */
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_I2S1CLKSOURCE_SYSCLK  System Clock selected as I2S1
 * clock
 *            @arg @ref RCC_I2S1CLKSOURCE_PLL     PLLP Clock selected as I2S1
 * clock
 *            @arg @ref RCC_I2S1CLKSOURCE_HSI     HSI Clock selected as I2S1
 * clock
 *            @arg @ref RCC_I2S1CLKSOURCE_EXT     External clock selected as
 * I2S1 clock
 */
#if defined(STM32G0C1xx) || defined(STM32G0B1xx) || defined(STM32G0B0xx)
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_I2S2CLKSOURCE_SYSCLK  System Clock selected as I2S2
 * clock
 *            @arg @ref RCC_I2S2CLKSOURCE_PLL     PLLP Clock selected as I2S2
 * clock
 *            @arg @ref RCC_I2S2CLKSOURCE_HSI     HSI Clock selected as I2S2
 * clock
 *            @arg @ref RCC_I2S2CLKSOURCE_EXT     External clock selected as
 * I2S2 clock
 */
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_USART1CLKSOURCE_PCLK1   PCLK1 selected as USART1
 * clock
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_LPUART2CLKSOURCE_PCLK1   PCLK1 selected as LPUART2
 * clock
 *            @arg @ref RCC_LPUART2CLKSOURCE_HSI  HSI selected as LPUART2 clock
 *            @arg @ref RCC_LPUART2CLKSOURCE_SYSCLK  System Clock selected as
 * LPUART2 clock
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_LPTIM2CLKSOURCE_PCLK1  PCLK1 selected as LPTIM2
 * clock
 ...
 * clock
 *            @arg @ref RCC_LPTIM2CLKSOURCE_LSI  HSI selected as LPTIM2 clock
 *            @arg @ref RCC_LPTIM2CLKSOURCE_HSI  System Clock selected as LPTIM2
 * clock
 *            @arg @ref RCC_LPTIM2CLKSOURCE_LSE  LSE selected as LPTIM2 clock
 */
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_CECCLKSOURCE_HSI_DIV488 HSI_DIV_488 selected as CEC
 * clock
 *            @arg @ref RCC_CECCLKSOURCE_LSE LSE selected as CEC clock
 */
#define __HAL_RCC_CEC_CONFIG(__CEC_CLKSOURCE__) MODIFY_REG(RCC->CCIPR, RCC_CCIPR_CECSEL, (uint32_t)(__CEC_CLKSOURCE__))

/** @brief  Macro to get the CEC clock source.
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_CECCLKSOURCE_HSI_DIV488 HSI_DIV_488 Clock selected
 * as CEC clock
 *            @arg @ref RCC_CECCLKSOURCE_LSE  LSE selected as CEC clock
 */
 ...
 *            @arg @ref RCC_RNGCLKSOURCE_HSI_DIV8 HSI Clock divided by 8
 * selected as RNG clock
 *            @arg @ref RCC_RNGCLKSOURCE_SYSCLK System Clock selected as RNG
 * clock
 *            @arg @ref RCC_RNGCLKSOURCE_PLL PLLQ Output Clock selected as RNG
 * clock
 */
#define __HAL_RCC_RNG_CONFIG(__RNG_CLKSOURCE__) MODIFY_REG(RCC->CCIPR, RCC_CCIPR_RNGSEL, (uint32_t)(__RNG_CLKSOURCE__))

/** @brief  Macro to get the RNG clock.
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_RNGCLKSOURCE_NONE  No clock selected as RNG clock
 *            @arg @ref RCC_RNGCLKSOURCE_HSI_DIV8 HSI Clock divide by 8 selected
 * as RNG clock
 *            @arg @ref RCC_RNGCLKSOURCE_SYSCLK System clock selected as RNG
 * clock
 *            @arg @ref RCC_RNGCLKSOURCE_PLL PLLQ Output Clock selected as RNG
 ...
 */
#define __HAL_RCC_RNGDIV_CONFIG(__RNG_CLKDIV__) MODIFY_REG(RCC->CCIPR, RCC_CCIPR_RNGDIV, (uint32_t)(__RNG_CLKDIV__))
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_ADCCLKSOURCE_PLLADC PLL "P" (PLLADC) Clock selected
 * as ADC clock
 *            @arg @ref RCC_ADCCLKSOURCE_SYSCLK System Clock selected as ADC
 * clock
 *            @arg @ref RCC_ADCCLKSOURCE_HSI HSI Clock selected as ADC clock
 */
#define __HAL_RCC_ADC_CONFIG(__ADC_CLKSOURCE__) MODIFY_REG(RCC->CCIPR, RCC_CCIPR_ADCSEL, (uint32_t)(__ADC_CLKSOURCE__))
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_TIM1CLKSOURCE_PLL PLLQ Output Clock selected as TIM1
 * clock
 *            @arg @ref RCC_TIM1CLKSOURCE_PCLK1 System Clock selected as TIM1
 * clock
 */
 ...
 * @param  __TIM15_CLKSOURCE__ specifies the TIM15 digital interface clock
 * source. This parameter can be one of the following values:
 *            @arg RCC_TIM15CLKSOURCE_PLL PLLQ Output Clock selected as TIM15
 * clock
 *            @arg RCC_TIM15CLKSOURCE_PCLK1  System Clock selected as TIM15
 * clock
 */
 ...
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_TIM15CLKSOURCE_PLL PLLQ Output Clock selected as
 * TIM15 clock
 *            @arg @ref RCC_TIM15CLKSOURCE_PCLK1  System Clock selected as TIM15
 * clock
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_USBCLKSOURCE_PLL    PLLQ Output Clock selected as
 * USB clock (*)
 *            @arg @ref RCC_USBCLKSOURCE_HSE    HSE Output Clock selected as USB
 * clock
 *            @arg @ref RCC_USBCLKSOURCE_HSI48  HSI48 Clock selected as USB
 * clock (*)
 ...
 * @param  __FDCAN_CLKSOURCE__ specifies the FDCAN digital interface clock
 * source. This parameter can be one of the following values:
 *            @arg RCC_FDCANCLKSOURCE_PLL    PLLQ Output Clock selected as FDCAN
 * clock
 *            @arg RCC_FDCANCLKSOURCE_PCLK1  System Clock selected as FDCAN
 * clock
 ...
 * @retval The clock source can be one of the following values:
 *            @arg @ref RCC_FDCANCLKSOURCE_PLL    PLLQ Output Clock selected as
 * FDCAN clock
 *            @arg @ref RCC_FDCANCLKSOURCE_PCLK1  System Clock selected as FDCAN
 * clock
 *            @arg @ref RCC_FDCANCLKSOURCE_HSE    HSE Clock selected as FDCAN
 * clock
 */
...
#define IS_RCC_USART1CLKSOURCE(__SOURCE__)                                                                             \
    (((__SOURCE__) == RCC_USART1CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_USART1CLKSOURCE_SYSCLK) ||                    \
...
#define IS_RCC_LPUART1CLKSOURCE(__SOURCE__)                                                                            \
    (((__SOURCE__) == RCC_LPUART1CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_LPUART1CLKSOURCE_SYSCLK) ||                  \
     ((__SOURCE__) == RCC_LPUART1CLKSOURCE_LSE) || ((__SOURCE__) == RCC_LPUART1CLKSOURCE_HSI))
#endif /* LPUART1 */

#if defined(LPUART2)
#define IS_RCC_LPUART2CLKSOURCE(__SOURCE__)                                                                            \
    (((__SOURCE__) == RCC_LPUART2CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_LPUART2CLKSOURCE_SYSCLK) ||                  \
     ((__SOURCE__) == RCC_LPUART2CLKSOURCE_LSE) || ((__SOURCE__) == RCC_LPUART2CLKSOURCE_HSI))
#endif /* LPUART2 */
...
#define IS_RCC_I2S1CLKSOURCE(__SOURCE__)                                                                               \
    (((__SOURCE__) == RCC_I2S1CLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_I2S1CLKSOURCE_PLL) ||                          \
     ((__SOURCE__) == RCC_I2S1CLKSOURCE_HSI) || ((__SOURCE__) == RCC_I2S1CLKSOURCE_EXT))

#if defined(RCC_CCIPR2_I2S2SEL)
#define IS_RCC_I2S2CLKSOURCE(__SOURCE__)                                                                               \
    (((__SOURCE__) == RCC_I2S2CLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_I2S2CLKSOURCE_PLL) ||                          \
     ((__SOURCE__) == RCC_I2S2CLKSOURCE_HSI) || ((__SOURCE__) == RCC_I2S2CLKSOURCE_EXT))
#endif /* RCC_CCIPR2_I2S2SEL */

#if defined(RCC_CCIPR_LPTIM1SEL)
#define IS_RCC_LPTIM1CLKSOURCE(__SOURCE__)                                                                             \
    (((__SOURCE__) == RCC_LPTIM1CLKSOURCE_PCLK1) || ((__SOURCE__) == RCC_LPTIM1CLKSOURCE_LSI) ||                       \
...
#define IS_RCC_ADCCLKSOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == RCC_ADCCLKSOURCE_PLLADC) || ((__SOURCE__) == RCC_ADCCLKSOURCE_SYSCLK) ||                         \
     ((__SOURCE__) == RCC_ADCCLKSOURCE_HSI))

#if defined(RNG)
#define IS_RCC_RNGCLKSOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == RCC_RNGCLKSOURCE_NONE) || ((__SOURCE__) == RCC_RNGCLKSOURCE_HSI_DIV8) ||                         \
     ((__SOURCE__) == RCC_RNGCLKSOURCE_SYSCLK) || ((__SOURCE__) == RCC_RNGCLKSOURCE_PLL))
#define IS_RCC_RNGDIV(__DIV__)                                                                                         \
    (((__DIV__) == RCC_RNGCLK_DIV1) || ((__DIV__) == RCC_RNGCLK_DIV2) || ((__DIV__) == RCC_RNGCLK_DIV4) ||             \
     ((__DIV__) == RCC_RNGCLK_DIV8))
#endif /* RNG */

#if defined(CEC)
#define IS_RCC_CECCLKSOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == RCC_CECCLKSOURCE_HSI_DIV488) || ((__SOURCE__) == RCC_CECCLKSOURCE_LSE))
#endif /* CEC */

#if defined(FDCAN1) || defined(FDCAN2)
#define IS_RCC_FDCANCLKSOURCE(__SOURCE__)                                                                              \
    (((__SOURCE__) == RCC_FDCANCLKSOURCE_HSE) || ((__SOURCE__) == RCC_FDCANCLKSOURCE_PLL) ||                           \
...
#define IS_RCC_USBCLKSOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == RCC_USBCLKSOURCE_HSI48) || ((__SOURCE__) == RCC_USBCLKSOURCE_HSE) ||                             \
     ((__SOURCE__) == RCC_USBCLKSOURCE_PLL))
#else
#define IS_RCC_USBCLKSOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == RCC_USBCLKSOURCE_HSE) || ((__SOURCE__) == RCC_USBCLKSOURCE_PLL))
#endif /* RCC_HSI48_SUPPORT */

#if defined(RCC_CCIPR_TIM1SEL)
#define IS_RCC_TIM1CLKSOURCE(__SOURCE__)                                                                               \
    (((__SOURCE__) == RCC_TIM1CLKSOURCE_PLL) || ((__SOURCE__) == RCC_TIM1CLKSOURCE_PCLK1))
#endif /* RCC_CCIPR_TIM1SEL */

#if defined(RCC_CCIPR_TIM15SEL)
#define IS_RCC_TIM15CLKSOURCE(__SOURCE__)                                                                              \
    (((__SOURCE__) == RCC_TIM15CLKSOURCE_PLL) || ((__SOURCE__) == RCC_TIM15CLKSOURCE_PCLK1))
#endif /* RCC_CCIPR_TIM15SEL */
