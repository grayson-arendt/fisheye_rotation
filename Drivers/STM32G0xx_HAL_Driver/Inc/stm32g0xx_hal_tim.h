...
#include "stm32g0xx_hal_def.h"
    ...
    typedef struct
    {
        ...
        uint32_t OCFastMode; /*!< Specifies the Fast mode state.
                                ...
                                TIM_Output_Fast_State
                                  @note This parameter is valid only in PWM1 and
                                PWM2 mode. */
        ...
        uint32_t OCNIdleState; /*!< Specifies the TIM Output Compare pin state
                                  ...
                                  of @ref TIM_Output_Compare_N_Idle_State
                                    @note This parameter is valid only for timer
                                  instances supporting break feature. */
    } TIM_OC_InitTypeDef;
    ...
    typedef struct
    {
        ...
        uint32_t ClearInputPrescaler; /*!< TIM Clear Input prescaler
                                           This parameter must be 0: When OCRef
                                         clear feature is used with ETR source, ETR
    ...
    typedef struct
    {
        ...
        uint32_t MasterSlaveMode;      /*!< Master/slave mode selection
                                          ...
                                          TIM_Master_Slave_Mode
                                            @note When the Master/slave mode is enabled,
                                          the effect of      an event on the trigger input
                                          (TRGI) is delayed to allow a      perfect
                                          synchronization between the current timer and
                                          its      slaves (through TRGO). It is not mandatory
                                          in case of timer      synchronization mode. */
    ...
    typedef struct
    {
        uint32_t OffStateRunMode; /*!< TIM off state in run mode, This parameter can be a
                                     value of @ref
        ...
        uint32_t LockLevel; /*!< TIM Lock level, This parameter can be a value of
                               @ref TIM_Lock_level */

        uint32_t DeadTime; /*!< TIM dead Time, This parameter can be a number
        ...
        uint32_t BreakPolarity; /*!< TIM Break input polarity, This parameter can be
                                   a value of @ref TIM_Break_Polarity */
        ...
        uint32_t Break2State; /*!< TIM Break2 State, This parameter can be a value
                                 of @ref TIM_Break2_Input_enable_disable */

        uint32_t Break2Polarity; /*!< TIM Break2 input polarity, This parameter can
                                    be a value of @ref TIM_Break2_Polarity */
...
#define TIM_ICPOLARITY_BOTHEDGE                                                                                        \
    TIM_INPUTCHANNELPOLARITY_BOTHEDGE /*!< Capture triggered by both rising                                            \
                                         and falling edges on timer input*/
/**
 * @}
 */
...
#define TIM_ICSELECTION_DIRECTTI                                                                                       \
    TIM_CCMR1_CC1S_0 /*!< TIM Input 1, 2, 3 or 4 is selected to be connected                                           \
                        to IC1, IC2, IC3 or IC4, respectively */
#define TIM_ICSELECTION_INDIRECTTI                                                                                     \
    TIM_CCMR1_CC1S_1 /*!< TIM Input 1, 2, 3 or 4 is selected to be connected                                           \
                        to IC2, IC1, IC4 or IC3, respectively */
...
#define TIM_ENCODERMODE_TI12                                                                                           \
    (TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode, counts up/down                          \
                                         on both TI1FP1 and TI2FP2 edges depending on the level                        \
                                         of the other input. */
/**
 * @}
 */
...
#define TIM_COMMUTATION_TRGI                                                                                           \
    TIM_CR2_CCUS /*!< When Capture/compare control bits are preloaded, they                                            \
                    are updated by setting the COMG bit or when an rising edge                                         \
...
#define TIM_DMA_CC1                                                                                                    \
    TIM_DIER_CC1DE /*!< DMA request is triggered by the capture/compare macth                                          \
                      1 event */
#define TIM_DMA_CC2                                                                                                    \
    TIM_DIER_CC2DE /*!< DMA request is triggered by the capture/compare macth                                          \
                      2 event event */
#define TIM_DMA_CC3                                                                                                    \
    TIM_DIER_CC3DE /*!< DMA request is triggered by the capture/compare macth                                          \
                      3 event event */
#define TIM_DMA_CC4                                                                                                    \
    TIM_DIER_CC4DE                   /*!< DMA request is triggered by the capture/compare macth                        \
                                        4 event event */
...
#define TIM_TRGO_OC1                                                                                                   \
    (TIM_CR2_MMS_1 | TIM_CR2_MMS_0)                     /*!< Capture or a compare match 1 is used                      \
...
#define TIM_TRGO2_OC6REF_RISINGFALLING                                                                                 \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC6REF rising or falling edges generate pulses on          \
                                                          TRGO2        */
...
#define TIM_TRGO2_OC5REF_RISING_OC6REF_FALLING                                                                         \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC5REF or OC6REF rising edges generate    \
                                                                           pulses on TRGO2         */
/**
 * @}
 */
...
#define IS_TIM_CLEARINPUT_SOURCE(__MODE__)                                                                             \
    (((__MODE__) == TIM_CLEARINPUTSOURCE_ETR) || ((__MODE__) == TIM_CLEARINPUTSOURCE_COMP1) ||                         \
     ((__MODE__) == TIM_CLEARINPUTSOURCE_COMP2) || ((__MODE__) == TIM_CLEARINPUTSOURCE_NONE))
#else
#define IS_TIM_CLEARINPUT_SOURCE(__MODE__)                                                                             \
    (((__MODE__) == TIM_CLEARINPUTSOURCE_ETR) || ((__MODE__) == TIM_CLEARINPUTSOURCE_NONE))
#endif /* COMP1 && COMP2 && COMP3 */
...
#define IS_TIM_DMA_BASE(__BASE__)                                                                                      \
    (((__BASE__) == TIM_DMABASE_CR1) || ((__BASE__) == TIM_DMABASE_CR2) || ((__BASE__) == TIM_DMABASE_SMCR) ||         \
     ...
     ((__BASE__) == TIM_DMABASE_OR1) || ((__BASE__) == TIM_DMABASE_CCMR3) || ((__BASE__) == TIM_DMABASE_CCR5) ||       \
     ((__BASE__) == TIM_DMABASE_CCR6) || ((__BASE__) == TIM_DMABASE_AF1) || ((__BASE__) == TIM_DMABASE_AF2) ||         \
...
#define IS_TIM_TRGO2_SOURCE(__SOURCE__)                                                                                \
    (((__SOURCE__) == TIM_TRGO2_RESET) || ((__SOURCE__) == TIM_TRGO2_ENABLE) || ((__SOURCE__) == TIM_TRGO2_UPDATE) ||  \
     ((__SOURCE__) == TIM_TRGO2_OC1) || ((__SOURCE__) == TIM_TRGO2_OC1REF) || ((__SOURCE__) == TIM_TRGO2_OC2REF) ||    \
     ((__SOURCE__) == TIM_TRGO2_OC3REF) || ((__SOURCE__) == TIM_TRGO2_OC3REF) || ((__SOURCE__) == TIM_TRGO2_OC4REF) || \
     ((__SOURCE__) == TIM_TRGO2_OC5REF) || ((__SOURCE__) == TIM_TRGO2_OC6REF) ||                                       \
     ((__SOURCE__) == TIM_TRGO2_OC4REF_RISINGFALLING) || ((__SOURCE__) == TIM_TRGO2_OC6REF_RISINGFALLING) ||           \
...
#define IS_TIM_PWM_MODE(__MODE__)                                                                                      \
    (((__MODE__) == TIM_OCMODE_PWM1) || ((__MODE__) == TIM_OCMODE_PWM2) || ((__MODE__) == TIM_OCMODE_COMBINED_PWM1) || \
     ((__MODE__) == TIM_OCMODE_COMBINED_PWM2) || ((__MODE__) == TIM_OCMODE_ASYMMETRIC_PWM1) ||                         \
...
#define IS_TIM_OC_MODE(__MODE__)                                                                                       \
    (((__MODE__) == TIM_OCMODE_TIMING) || ((__MODE__) == TIM_OCMODE_ACTIVE) || ((__MODE__) == TIM_OCMODE_INACTIVE) ||  \
     ...
     ((__MODE__) == TIM_OCMODE_FORCED_INACTIVE) || ((__MODE__) == TIM_OCMODE_RETRIGERRABLE_OPM1) ||                    \
...
#define IS_TIM_TRIGGER_SELECTION(__SELECTION__)                                                                        \
    (((__SELECTION__) == TIM_TS_ITR0) || ((__SELECTION__) == TIM_TS_ITR1) || ((__SELECTION__) == TIM_TS_ITR2) ||       \
     ((__SELECTION__) == TIM_TS_ITR3) || ((__SELECTION__) == TIM_TS_ITR7) || ((__SELECTION__) == TIM_TS_TI1F_ED) ||    \
...
#else
#define IS_TIM_BREAK_SYSTEM(__CONFIG__)                                                                                \
    (((__CONFIG__) == TIM_BREAK_SYSTEM_ECC) || ((__CONFIG__) == TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR) ||                 \
