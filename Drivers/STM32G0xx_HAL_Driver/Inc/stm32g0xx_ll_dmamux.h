...
#define LL_DMAMUX_SYNC_EXTI_LINE3                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_1 | DMAMUX_CxCR_SYNC_ID_0)     /*!< Synchronization signal from EXTI Line3  */
...
#define LL_DMAMUX_SYNC_EXTI_LINE5                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from EXTI Line5  */
#define LL_DMAMUX_SYNC_EXTI_LINE6                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1) /*!< Synchronization signal from EXTI Line6  */
...
#define LL_DMAMUX_SYNC_EXTI_LINE9                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from EXTI Line9  */
...
#define LL_DMAMUX_SYNC_EXTI_LINE13                                                                                     \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 |                                                                   \
     DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from EXTI Line1 3 */
#define LL_DMAMUX_SYNC_EXTI_LINE14                                                                                     \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 |                                                                   \
     DMAMUX_CxCR_SYNC_ID_1) /*!< Synchronization signal from EXTI Line1 4 */
#define LL_DMAMUX_SYNC_EXTI_LINE15                                                                                     \
    (DMAMUX_CxCR_SYNC_ID_3 | DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1 |                                           \
     DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from EXTI Line1 5 */
...
#define LL_DMAMUX_SYNC_DMAMUX_CH1                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from DMAMUX channel1                   \
                                                       Event */
#define LL_DMAMUX_SYNC_DMAMUX_CH2                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_1) /*!< Synchronization signal from DMAMUX channel2                   \
                                                       Event */
#define LL_DMAMUX_SYNC_DMAMUX_CH3                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_1 | DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from DMAMUX    \
                                                                               channel3 Event */
#if defined(LPTIM1)
...
#define LL_DMAMUX_SYNC_LPTIM2_OUT                                                                                      \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_2 |                                                                   \
     DMAMUX_CxCR_SYNC_ID_0) /*!< Synchronization signal from LPTIM2 Output */
#endif                      /* LPTIM2 */
#define LL_DMAMUX_SYNC_TIM14_OC                                                                                        \
    (DMAMUX_CxCR_SYNC_ID_4 | DMAMUX_CxCR_SYNC_ID_2 | DMAMUX_CxCR_SYNC_ID_1) /*!< Synchronization signal from TIM14 OC  \
                                                                             */
/**
 * @}
 */
...
#define LL_DMAMUX_REQ_GEN_POL_RISING_FALLING                                                                           \
    (DMAMUX_RGxCR_GPOL_0 | DMAMUX_RGxCR_GPOL_1) /*!< External DMA request generation on rising and                     \
                                                   falling edge */
/**
 * @}
 */
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE10                                                                                  \
    (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_1) /*!< Request signal generation from EXTI Line10 */
...
#define LL_DMAMUX_REQ_GEN_EXTI_LINE12                                                                                  \
    (DMAMUX_RGxCR_SIG_ID_3 | DMAMUX_RGxCR_SIG_ID_2) /*!< Request signal generation from EXTI Line12 */
...
#define LL_DMAMUX_REQ_GEN_DMAMUX_CH3                                                                                   \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_1 | DMAMUX_RGxCR_SIG_ID_0) /*!< Request signal generation from DMAMUX \
                                                                               channel3 Event */
#if defined(LPTIM1)
#define LL_DMAMUX_REQ_GEN_LPTIM1_OUT                                                                                   \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_2) /*!< Request signal generation from LPTIM1 Output                  \
                                                     */
#endif                                              /* LPTIM1 */
#if defined(LPTIM2)
#define LL_DMAMUX_REQ_GEN_LPTIM2_OUT                                                                                   \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_2 |                                                                   \
     DMAMUX_RGxCR_SIG_ID_0) /*!< Request signal generation from LPTIM2 Output                                          \
                             */
#endif                      /* LPTIM2 */
#define LL_DMAMUX_REQ_GEN_TIM14_OC                                                                                     \
    (DMAMUX_RGxCR_SIG_ID_4 | DMAMUX_RGxCR_SIG_ID_2 |                                                                   \
     DMAMUX_RGxCR_SIG_ID_1) /*!< Request signal generation from TIM14 OC */
/**
 * @}
 */
...
#define LL_DMAMUX_ReadReg(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
     ...
     *         DMAMUX channel 7 to 11 are mapped to DMA2 channel 1 to 5 (**** only
     * available on chip which support DMA2 ****).
     ...
     * ****)
     *
     *         @arg All the next values are only available on chip which support
     * DMA2:
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_DMAMUX_SetRequestID(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel,
                                                uint32_t Request)
    {
        (void)(DMAMUXx);
    ...
    {
        (void)(DMAMUXx);
        return (uint32_t)(((READ_BIT((DMAMUX1_Channel0 + Channel)->CCR, DMAMUX_CxCR_NBREQ)) >> DMAMUX_CxCR_NBREQ_Pos) +
                          1U);
    }
    ...
    {
        (void)(DMAMUXx);
        SET_BIT(((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 +
    ...
    {
        (void)(DMAMUXx);
        CLEAR_BIT(((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 +
                                                            (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))
                      ->RGCR,
                  DMAMUX_RGxCR_GE);
    }
    ...
    {
        (void)(DMAMUXx);
        return ((READ_BIT(((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 +
                                                                    (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))
                              ->RGCR,
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_DMAMUX_SetRequestGenPolarity(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                         uint32_t RequestGenChannel, uint32_t Polarity)
    {
        (void)(DMAMUXx);
        MODIFY_REG(((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 +
                                                             (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))
                       ->RGCR,
     ...
     * @retval Between Min_Data = 1 and Max_Data = 32
     */
    __STATIC_INLINE uint32_t LL_DMAMUX_GetGenRequestNb(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                       uint32_t RequestGenChannel)
    {
        (void)(DMAMUXx);
        return (
            uint32_t)((READ_BIT(((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 +
                                                                          (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))
                                    ->RGCR,
                                DMAMUX_RGxCR_GNBREQ) >>
     ...
     *         @arg @ref LL_DMAMUX_REQ_GEN_TIM14_OC
     */
    __STATIC_INLINE uint32_t LL_DMAMUX_GetRequestSignalID(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                          uint32_t RequestGenChannel)
    {
        (void)(DMAMUXx);
        return (uint32_t)(READ_BIT(((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 +
     ...
     * @retval State of bit (1 or 0).
     */
    __STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledIT_RGO(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                       uint32_t RequestGenChannel)
    {
        (void)(DMAMUXx);
        return (
            (READ_BIT((DMAMUX1_RequestGenerator0 + RequestGenChannel)->RGCR, DMAMUX_RGxCR_OIE) == (DMAMUX_RGxCR_OIE))
                ? 1UL
                : 0UL);
    }
