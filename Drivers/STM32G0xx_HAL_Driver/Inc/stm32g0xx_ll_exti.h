...
/* Exported types ------------------------------------------------------------*/
    ...
    typedef struct
    {
        ...
        uint32_t Line_32_63;         /*!< Specifies the EXTI lines to be enabled or disabled
                                        for Lines in range 32 to 63 This parameter can be
                                        any combination of @ref EXTI_LL_EC_LINE */
#endif                               /* STM32G081xx || STM32G071xx || STM32G0C1xx || STM32G0B1xx ||                    \
                                        STM32G0B0xx */
        FunctionalState LineCommand; /*!< Specifies the new state of the selected
                                        EXTI lines. This parameter can be set either
                                        to ENABLE or DISABLE */

        uint8_t Mode; /*!< Specifies the mode for the EXTI lines.
                           This parameter can be a value of @ref EXTI_LL_EC_MODE. */

        uint8_t Trigger; /*!< Specifies the trigger signal active edge for the EXTI
                            lines. This parameter can be a value of @ref
                            EXTI_LL_EC_TRIGGER. */
    } LL_EXTI_InitTypeDef;
...
#if defined(EXTI_IMR2_IM32) || defined(EXTI_IMR2_IM33) || defined(EXTI_IMR2_IM34) || defined(EXTI_IMR2_IM35) ||        \
    defined(EXTI_IMR2_IM36)
#define LL_EXTI_LINE_ALL_32_63 EXTI_IMR2_IM /*!< All Extended line not reserved*/
#endif                                      /* EXTI_IMR2_IM32 || EXTI_IMR2_IM33 || EXTI_IMR2_IM34 || EXTI_IMR2_IM35    \
                                               || EXTI_IMR2_IM36 */
...
#define LL_EXTI_ReadReg(__REG__) READ_REG(EXTI->__REG__)
    ...
    /**
     * @brief  Check if the ExtLine Falling Flag is set or not for Lines in range 0
     * to 31
...
#if defined(STM32G0C1xx) || defined(STM32G0B1xx)
    /**
     * @brief  Check if the ExtLine Falling Flag is set or not for Lines in range 32
     * to 63
     * @note This bit is set when the falling edge event arrives on the interrupt
     *       line. This bit is cleared by writing a 1 to the bit.
    ...
    /**
     * @brief  Check if the ExtLine Rising Flag is set or not for Lines in range 0
     * to 31
...
#if defined(STM32G0C1xx) || defined(STM32G0B1xx)
    /**
     * @brief  Check if the ExtLine Rising Flag is set or not for Lines in range 32
     * to 63
     * @note This bit is set when the Rising edge event arrives on the interrupt
     *       line. This bit is cleared by writing a 1 to the bit.
