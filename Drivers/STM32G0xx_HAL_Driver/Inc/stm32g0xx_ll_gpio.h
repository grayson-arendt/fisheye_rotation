...
/* Exported types ------------------------------------------------------------*/
    ...
    typedef struct
    {
        ...
        uint32_t OutputType; /*!< Specifies the operating output type for the selected
...
#define LL_GPIO_PIN_ALL                                                                                                \
    (GPIO_BSRR_BS0 | GPIO_BSRR_BS1 | GPIO_BSRR_BS2 | GPIO_BSRR_BS3 | GPIO_BSRR_BS4 | GPIO_BSRR_BS5 | GPIO_BSRR_BS6 |   \
     GPIO_BSRR_BS7 | GPIO_BSRR_BS8 | GPIO_BSRR_BS9 | GPIO_BSRR_BS10 | GPIO_BSRR_BS11 | GPIO_BSRR_BS12 |                \
     GPIO_BSRR_BS13 | GPIO_BSRR_BS14 | GPIO_BSRR_BS15) /*!< Select all pins */
/**
 * @}
 */
...
#define LL_GPIO_ReadReg(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
    ...
    {
        return (uint32_t)(READ_BIT(GPIOx->AFR[0], ((((Pin * Pin) * Pin) * Pin) * GPIO_AFRL_AFSEL0)) /
                          (((Pin * Pin) * Pin) * Pin));
    }
 ...
 */
     ...
     */
          ...
          (GPIOD) || defined (GPIOE) || defined (GPIOF) */
    /**
     * @}
     */
