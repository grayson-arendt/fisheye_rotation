...
#include "stm32g0xx.h"
    ...
    static const uint16_t LPUART_PRESCALER_TAB[] = {(uint16_t)1,   (uint16_t)2,   (uint16_t)4,   (uint16_t)6,
                                                    ...
                                                    (uint16_t)256, (uint16_t)256, (uint16_t)256, (uint16_t)256};
/**
 * @}
 */
...
/* Exported types ------------------------------------------------------------*/
    ...
    typedef struct
    {
        ...
        uint32_t BaudRate; /*!< This field defines expected LPUART communication
                              baud rate.

                                This feature can be modified afterwards using
                              unitary function @ref LL_LPUART_SetBaudRate().*/
        ...
        uint32_t DataWidth; /*!< Specifies the number of data bits transmitted or
                               ...
                               @ref LPUART_LL_EC_DATAWIDTH.
                                 ...
                                 This feature can be modified afterwards using
                               unitary function @ref LL_LPUART_SetDataWidth().*/
        ...
        uint32_t StopBits; /*!< Specifies the number of stop bits transmitted.
                              ...
                              LPUART_LL_EC_STOPBITS.
                                ...
                                This feature can be modified afterwards using
                              unitary function @ref LL_LPUART_SetStopBitsLength().*/
        ...
        uint32_t TransferDirection; /*!< Specifies whether the Receive and/or Transmit
                                       ...
                                       a value of @ref LPUART_LL_EC_DIRECTION.
        ...
        uint32_t HardwareFlowControl; /*!< Specifies whether the hardware flow control
                                         ...
                                         be a value of @ref LPUART_LL_EC_HWCONTROL.
...
#define __LL_LPUART_DIV(__PERIPHCLK__, __PRESCALER__, __BAUDRATE__)                                                    \
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_LPUART_ConfigFIFOsThreshold(USART_TypeDef *LPUARTx, uint32_t TXThreshold,
