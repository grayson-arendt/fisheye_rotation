...
#define LL_PWR_PVDHLEVEL_7                                                                                             \
    (PWR_CR2_PVDRT_2 | PWR_CR2_PVDRT_1 | PWR_CR2_PVDRT_0) /* External input analog voltage   (Compare internally       \
                                                             to VREFINT) */
/**
 * @}
 */
...
#define LL_PWR_PVM_ENABLE                                                                                              \
    (PWR_CR2_PVM_VDDIO2_0) /*!< VDDIO2 monitoring enabled, IOs enabled or in                                           \
                              isolation mode, according to VDDIO2 level */
#define LL_PWR_PVM_BYPASS                                                                                              \
    (PWR_CR2_PVM_VDDIO2_1 | PWR_CR2_PVM_VDDIO2_2) /*!< VDDIO2 monitoring bypassed, IOs enabled                         \
                                                   */
/**
 * @}
 */
...
#define LL_PWR_ReadReg(__REG__) READ_REG(PWR->__REG__)
    ...
    /**
     * @brief  Check if flash power-down mode during low power sleep mode domain is
     * enabled
    ...
    /**
     * @brief  Check if flash power-down mode during low power run mode domain is
     * enabled
     ...
     * configuration is now handled by LL_PWR_SetPVM(). The USV, IOSV, and PVMENUSB
     * bits have been merged into the PVM_VDDIO2 bitfield of the PWR_CR2 register.
     *         Please refer to RM0444 Rev6 or later, section "Power control register
     * 2 (PWR_CR2)".
     * @retval None
     */
     ...
     * @note   For STM32G0C1xx and STM32G0B1xx devices, this function is deprecated
     * and retained only to ensure backward compatibility. Power Voltage Monitoring
     * configuration is now handled by LL_PWR_GetPVM(). The USV, IOSV, and PVMENUSB
     * bits have been merged into the PVM_VDDIO2 bitfield of the PWR_CR2 register.
     *         Please refer to RM0444 Rev6 or later, section "Power control register
     * 2 (PWR_CR2)".
     * @retval State of bit (1 or 0).
...
#if defined(PWR_CR2_PVDE)
    /**
     * @brief  Configure the high voltage threshold detected by the Power Voltage
     * Detector
    ...
    /**
     * @brief  Configure the low voltage threshold detected by the Power Voltage
     * Detector
