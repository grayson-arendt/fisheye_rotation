...
#define LL_SYSCFG_REMAP_SRAM                                                                                           \
    (SYSCFG_CFGR1_MEM_MODE_1 | SYSCFG_CFGR1_MEM_MODE_0) /*!< Embedded SRAM mapped at 0x00000000 */
/**
 * @}
 */
...
#define LL_SYSCFG_IR_MOD_TIM16                                                                                         \
    (SYSCFG_CFGR1_IR_MOD_0 & SYSCFG_CFGR1_IR_MOD_1) /*!< 00: Timer16 is selected as IRDA Modulation                    \
                                                       envelope source */
#define LL_SYSCFG_IR_MOD_USART1                                                                                        \
    (SYSCFG_CFGR1_IR_MOD_0) /*!< 01: USART1 is selected as IRDA Modulation                                             \
                               envelope source */
#if defined(USART4)
#define LL_SYSCFG_IR_MOD_USART4                                                                                        \
    (SYSCFG_CFGR1_IR_MOD_1) /*!< 10: USART4 is selected as IRDA Modulation                                             \
                               envelope source */
#else
#define LL_SYSCFG_IR_MOD_USART2                                                                                        \
    (SYSCFG_CFGR1_IR_MOD_1) /*!< 10: USART2 is selected as IRDA Modulation                                             \
                               envelope source */
#endif                      /* USART4 */
/**
 * @}
...
/** @defgroup SYSTEM_LL_EC_BOOSTEN SYSCFG I/O analog switch voltage booster
 * enable
 * @{
 */
...
/** @defgroup SYSTEM_LL_EC_UCPD_DBATTDIS SYSCFG UCPD Dead Battery feature
 * Disable
 * @{
 */
...
#define LL_SYSCFG_TIMBREAK_LOCKUP                                                                                      \
    SYSCFG_CFGR2_CLL /*!< Enables and locks the LOCKUP (Hardfault) output of                                           \
...
#define LL_DBGMCU_APB1_GRP1_WWDG_STOP                                                                                  \
    DBG_APB_FZ1_DBG_WWDG_STOP /*!< Debug Window Watchdog stopped when Core is                                          \
                                 halted */
#define LL_DBGMCU_APB1_GRP1_IWDG_STOP                                                                                  \
    DBG_APB_FZ1_DBG_IWDG_STOP /*!< Debug Independent Watchdog stopped when                                             \
                                 Core is halted */
#define LL_DBGMCU_APB1_GRP1_I2C1_STOP                                                                                  \
    DBG_APB_FZ1_DBG_I2C1_SMBUS_TIMEOUT_STOP /*!< I2C1 SMBUS timeout mode                                               \
                                               stopped when Core is halted */
#if defined(STM32G0C1xx) || defined(STM32G0B1xx) || defined(STM32G0B0xx)
#define LL_DBGMCU_APB1_GRP1_I2C2_STOP                                                                                  \
    DBG_APB_FZ1_DBG_I2C2_SMBUS_TIMEOUT_STOP /*!< I2C2 SMBUS timeout mode                                               \
                                               stopped when Core is halted */
#endif                                      /* STM32G0C1xx || STM32G0B1xx || STM32G0B0xx */
#if defined(DBG_APB_FZ1_DBG_LPTIM2_STOP)
#define LL_DBGMCU_APB1_GRP1_LPTIM2_STOP                                                                                \
    DBG_APB_FZ1_DBG_LPTIM2_STOP /*!< LPTIM2 counter stopped when Core is                                               \
                                   halted */
#endif                          /* DBG_APB_FZ1_DBG_LPTIM2_STOP */
#if defined(DBG_APB_FZ1_DBG_LPTIM1_STOP)
#define LL_DBGMCU_APB1_GRP1_LPTIM1_STOP                                                                                \
    DBG_APB_FZ1_DBG_LPTIM1_STOP /*!< LPTIM1 counter stopped when Core is                                               \
                                   halted */
...
#define LL_DBGMCU_APB2_GRP1_TIM14_STOP                                                                                 \
    DBG_APB_FZ2_DBG_TIM14_STOP /*!< TIM14 counter stopped when core is halted                                          \
                                */
#endif                         /* DBG_APB_FZ2_DBG_TIM14_STOP */
#if defined(DBG_APB_FZ2_DBG_TIM15_STOP)
#define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                                                                 \
    DBG_APB_FZ2_DBG_TIM15_STOP /*!< TIM15 counter stopped when core is halted                                          \
                                */
#endif                         /*DBG_APB_FZ2_DBG_TIM15_STOP*/
#define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                                                                 \
    DBG_APB_FZ2_DBG_TIM16_STOP /*!< TIM16 counter stopped when core is halted                                          \
                                */
#define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                                                                 \
    DBG_APB_FZ2_DBG_TIM17_STOP /*!< TIM17 counter stopped when core is halted                                          \
                                */
    /**
     * @}
     */
...
#define LL_FLASH_LATENCY_3                                                                                             \
    (FLASH_ACR_LATENCY_1 | FLASH_ACR_LATENCY_0) /*!< FLASH Three wait states                                           \
                                                 */
    /**
     * @}
     */
     ...
     * @param  ConfigDeadBattery This parameter can be a combination of the
     * following values:
...
#if defined(PWR_PVD_SUPPORT)
    /**
     * @brief  Check if PVD supply monitoring interrupt occurred or not (EXTI line
     * 16).
    ...
    /**
     * @brief  Check if VDDUSB supply monitoring interrupt occurred or not (EXTI
     * line 34).
    ...
    /**
     * @brief  Check if RTC Tamper and TimeStamp interrupt occurred or not (EXTI
     * line 21).
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[3], SYSCFG_ITLINE3_SR_FLASH_ITF) == (SYSCFG_ITLINE3_SR_FLASH_ITF)) ? 1UL
                                                                                                                : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[3], SYSCFG_ITLINE3_SR_FLASH_ECC) == (SYSCFG_ITLINE3_SR_FLASH_ECC)) ? 1UL
                                                                                                                : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[4], SYSCFG_ITLINE4_SR_CLK_CTRL) == (SYSCFG_ITLINE4_SR_CLK_CTRL)) ? 1UL
                                                                                                              : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[9], SYSCFG_ITLINE9_SR_DMA1_CH1) == (SYSCFG_ITLINE9_SR_DMA1_CH1)) ? 1UL
                                                                                                              : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[10], SYSCFG_ITLINE10_SR_DMA1_CH2) == (SYSCFG_ITLINE10_SR_DMA1_CH2)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA1_CH4) == (SYSCFG_ITLINE11_SR_DMA1_CH4)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA1_CH5) == (SYSCFG_ITLINE11_SR_DMA1_CH5)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA1_CH6) == (SYSCFG_ITLINE11_SR_DMA1_CH6)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA1_CH7) == (SYSCFG_ITLINE11_SR_DMA1_CH7)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMAMUX1) == (SYSCFG_ITLINE11_SR_DMAMUX1)) ? 1UL
                                                                                                               : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH1) == (SYSCFG_ITLINE11_SR_DMA2_CH1)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH2) == (SYSCFG_ITLINE11_SR_DMA2_CH2)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH3) == (SYSCFG_ITLINE11_SR_DMA2_CH3)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH4) == (SYSCFG_ITLINE11_SR_DMA2_CH4)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[11], SYSCFG_ITLINE11_SR_DMA2_CH5) == (SYSCFG_ITLINE11_SR_DMA2_CH5)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[13], SYSCFG_ITLINE13_SR_TIM1_BRK) == (SYSCFG_ITLINE13_SR_TIM1_BRK)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[13], SYSCFG_ITLINE13_SR_TIM1_UPD) == (SYSCFG_ITLINE13_SR_TIM1_UPD)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[13], SYSCFG_ITLINE13_SR_TIM1_TRG) == (SYSCFG_ITLINE13_SR_TIM1_TRG)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[13], SYSCFG_ITLINE13_SR_TIM1_CCU) == (SYSCFG_ITLINE13_SR_TIM1_CCU)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[14], SYSCFG_ITLINE14_SR_TIM1_CC) == (SYSCFG_ITLINE14_SR_TIM1_CC)) ? 1UL
                                                                                                               : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[15], SYSCFG_ITLINE15_SR_TIM2_GLB) == (SYSCFG_ITLINE15_SR_TIM2_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[16], SYSCFG_ITLINE16_SR_TIM3_GLB) == (SYSCFG_ITLINE16_SR_TIM3_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[16], SYSCFG_ITLINE16_SR_TIM4_GLB) == (SYSCFG_ITLINE16_SR_TIM4_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[17], SYSCFG_ITLINE17_SR_TIM6_GLB) == (SYSCFG_ITLINE17_SR_TIM6_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[17], SYSCFG_ITLINE17_SR_LPTIM1_GLB) == (SYSCFG_ITLINE17_SR_LPTIM1_GLB))
                    ? 1UL
                    : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[18], SYSCFG_ITLINE18_SR_TIM7_GLB) == (SYSCFG_ITLINE18_SR_TIM7_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[18], SYSCFG_ITLINE18_SR_LPTIM2_GLB) == (SYSCFG_ITLINE18_SR_LPTIM2_GLB))
                    ? 1UL
                    : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[21], SYSCFG_ITLINE21_SR_FDCAN1_IT0) == (SYSCFG_ITLINE21_SR_FDCAN1_IT0))
                    ? 1UL
                    : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[21], SYSCFG_ITLINE21_SR_FDCAN2_IT0) == (SYSCFG_ITLINE21_SR_FDCAN2_IT0))
                    ? 1UL
                    : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[22], SYSCFG_ITLINE22_SR_FDCAN1_IT1) == (SYSCFG_ITLINE22_SR_FDCAN1_IT1))
                    ? 1UL
                    : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[22], SYSCFG_ITLINE22_SR_FDCAN2_IT1) == (SYSCFG_ITLINE22_SR_FDCAN2_IT1))
                    ? 1UL
                    : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[23], SYSCFG_ITLINE23_SR_I2C1_GLB) == (SYSCFG_ITLINE23_SR_I2C1_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[24], SYSCFG_ITLINE24_SR_I2C2_GLB) == (SYSCFG_ITLINE24_SR_I2C2_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[24], SYSCFG_ITLINE24_SR_I2C3_GLB) == (SYSCFG_ITLINE24_SR_I2C3_GLB)) ? 1UL
                                                                                                                 : 0UL);
    }
    ...
    /**
     * @brief  Check if USART1 interrupt occurred or not, combined with EXTI
     * line 25.
    ...
    /**
     * @brief  Check if USART2 interrupt occurred or not, combined with EXTI
     * line 26.
    ...
    /**
     * @brief  Check if LPUART2 interrupt occurred or not, combined with EXTI
     * line 26.
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[28], SYSCFG_ITLINE28_SR_LPUART2_GLB) == (SYSCFG_ITLINE28_SR_LPUART2_GLB))
                    ? 1UL
                    : 0UL);
    }
    ...
    /**
     * @brief  Check if USART3 interrupt occurred or not, combined with EXTI
     * line 28.
    ...
    {
        return ((READ_BIT(SYSCFG->IT_LINE_SR[29], SYSCFG_ITLINE29_SR_LPUART1_GLB) == (SYSCFG_ITLINE29_SR_LPUART1_GLB))
                    ? 1UL
                    : 0UL);
    }
    ...
    __STATIC_INLINE uint32_t LL_SYSCFG_GetTIMBreakInputs(void)
    {
        ...
        return (uint32_t)(READ_BIT(SYSCFG->CFGR2,
                                   SYSCFG_CFGR2_CLL | SYSCFG_CFGR2_SPL | SYSCFG_CFGR2_PVDL | SYSCFG_CFGR2_ECCL));
#else
     ...
     * @param  ConfigClampingDiode This parameter can be a combination of the
     * following values:
     ...
     *         DBG_APB_FZ1 DBG_I2C1_SMBUS_TIMEOUT
     * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBG_APB_FZ1 DBG_I2C2_SMBUS_TIMEOUT
     * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBG_APB_FZ1 DBG_LPTIM2_SMBUS_TIMEOUT
     * LL_DBGMCU_APB1_GRP1_UnFreezePeriph\n DBG_APB_FZ1 DBG_LPTIM1_SMBUS_TIMEOUT
     * LL_DBGMCU_APB1_GRP1_UnFreezePeriph
     * @param  Periphs This parameter can be a combination of the following values:
     *         @arg @ref LL_DBGMCU_APB1_GRP1_TIM2_STOP (*)
     *         @arg @ref LL_DBGMCU_APB1_GRP1_TIM3_STOP
