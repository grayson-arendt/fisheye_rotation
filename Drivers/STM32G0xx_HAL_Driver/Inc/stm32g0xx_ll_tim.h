...
#if defined(TIM1) || defined(TIM2) || defined(TIM3) || defined(TIM4) || defined(TIM14) || defined(TIM15) ||            \
    defined(TIM16) || defined(TIM17) || defined(TIM6) || defined(TIM7)
...
#define TIM_POSITION_BRK_SOURCE                                                                                        \
    ((Source == LL_TIM_BKIN_SOURCE_BKIN)      ? 0U                                                                     \
     ...
     : (Source == LL_TIM_BKIN_SOURCE_BKCOMP2) ? 2U                                                                     \
                                              : 3U)
#else
...
#define TIM_GET_CHANNEL_INDEX(__CHANNEL__)                                                                             \
    (((__CHANNEL__) == LL_TIM_CHANNEL_CH1)    ? 0U                                                                     \
     ...
     : ((__CHANNEL__) == LL_TIM_CHANNEL_CH5)  ? 7U                                                                     \
                                              : 8U)
...
/* Exported types ------------------------------------------------------------*/
    ...
    typedef struct
    {
        uint16_t Prescaler; /*!< Specifies the prescaler value used to divide the
                               TIM clock. This parameter can be a number between
        ...
        uint32_t Autoreload; /*!< Specifies the auto reload value to be loaded into the
                                active Auto-Reload Register at the next update event.
                                  This parameter must be a number between Min_Data=0x0000
                                and Max_Data=0xFFFF. Some timer instances may support 32
                                bits counters. In that case this parameter must be a
                                number between 0x0000 and 0xFFFFFFFF.
        ...
        uint32_t RepetitionCounter; /*!< Specifies the repetition counter value.
                                       Each time the RCR downcounter reaches zero,
                                       an update event is generated and counting
                                       restarts from the RCR value (N). This means
                                       in PWM mode that (N+1) corresponds to:
    ...
    typedef struct
    {
        ...
        uint32_t OCNIdleState; /*!< Specifies the TIM Output Compare pin state
                                  during Idle state. This parameter can be a value
                                  of @ref TIM_LL_EC_OCIDLESTATE.
    ...
    typedef struct
    {
        ...
        uint32_t CommutationDelay; /*!< Specifies the compare value to be loaded
                                      into the Capture Compare Register. A positive
                                      pulse (TRGO event) is generated with a
                                      programmable delay every time a change occurs
                                      on the Hall inputs. This parameter can be a
    ...
    typedef struct
    {
        uint32_t OSSRState; /*!< Specifies the Off-State selection used in Run mode.
                               ...
                               function
                                 ...
                                 @note This bit-field cannot be modified as long as LOCK
                               level 2 has been programmed. */
        ...
        uint8_t DeadTime; /*!< Specifies the delay time between the switching-off and
                             ...
                             level 1, 2 or 3 has been programmed. */
        ...
        uint32_t BreakAFMode; /*!< Specifies the alternate function mode of the
                                 break input. This parameter can be a value of @ref
        ...
        uint32_t Break2State; /*!< Specifies whether the TIM Break2 input is enabled or
                                 not. This parameter can be a value of @ref
        ...
        uint32_t Break2AFMode; /*!< Specifies the alternate function mode of the
                                  break2 input. This parameter can be a value of
                                  @ref TIM_LL_EC_BREAK2_AFMODE
...
#define LL_TIM_UPDATESOURCE_COUNTER                                                                                    \
    TIM_CR1_URS /*!< Only counter overflow/underflow generates an update                                               \
                   request */
/**
 * @}
 */
...
#define LL_TIM_OCMODE_FROZEN                                                                                           \
    0x00000000U                                 /*!<The comparison between the output compare register                 \
                                                   TIMx_CCRy and the counter TIMx_CNT has no effect on the             \
                                                   output channel level */
#define LL_TIM_OCMODE_ACTIVE TIM_CCMR1_OC1M_0   /*!<OCyREF is forced high on compare match*/
#define LL_TIM_OCMODE_INACTIVE TIM_CCMR1_OC1M_1 /*!<OCyREF is forced low on compare match*/
#define LL_TIM_OCMODE_TOGGLE                                                                                           \
    (TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_0)                                 /*!<OCyREF toggles on compare                \
                                                                             match*/
#define LL_TIM_OCMODE_FORCED_INACTIVE TIM_CCMR1_OC1M_2                    /*!<OCyREF is forced low*/
#define LL_TIM_OCMODE_FORCED_ACTIVE (TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_0) /*!<OCyREF is forced high*/
#define LL_TIM_OCMODE_PWM1                                                                                             \
    (TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_1) /*!<In upcounting, channel y is active as long as                            \
...
#define LL_TIM_OCMODE_PWM2                                                                                             \
    (TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_0) /*!<In upcounting, channel y is inactive as long as       \
                                                                TIMx_CNT<TIMx_CCRy else active.  In downcounting,      \
                                                                channel y is active as long as TIMx_CNT>TIMx_CCRy      \
                                                                else inactive*/
...
#define LL_TIM_OCIDLESTATE_LOW                                                                                         \
    0x00000000U /*!<OCx=0 (after a dead-time if OC is implemented) when                                                \
                   MOE=0*/
#define LL_TIM_OCIDLESTATE_HIGH                                                                                        \
    TIM_CR2_OIS1 /*!<OCx=1 (after a dead-time if OC is implemented) when                                               \
                    MOE=0*/
/**
 * @}
 */
...
#define LL_TIM_ICPSC_DIV1                                                                                              \
    0x00000000U                                       /*!< No prescaler, capture is done each time an edge is          \
...
#define LL_TIM_IC_POLARITY_BOTHEDGE                                                                                    \
    (TIM_CCER_CC1P | TIM_CCER_CC1NP) /*!< The circuit is sensitive to both TIxFP1 rising and                           \
...
#define LL_TIM_CLOCKSOURCE_EXT_MODE1                                                                                   \
    (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0) /*!< Counter counts at each rising or falling edge on a         \
                                                          selected input*/
...
#define LL_TIM_ENCODERMODE_X4_TI12                                                                                     \
    (TIM_SMCR_SMS_1 | TIM_SMCR_SMS_0) /*!< Quadrature encoder mode 3, x4 mode - Counter counts                         \
                                         up/down on both TI1FP1 and TI2FP2 edges depending on                          \
...
#define LL_TIM_TRGO_RESET                                                                                              \
    0x00000000U /*!< UG bit from the TIMx_EGR register is used as trigger                                              \
                   output */
#define LL_TIM_TRGO_ENABLE                                                                                             \
    TIM_CR2_MMS_0                        /*!< Counter Enable signal (CNT_EN) is used as trigger                        \
                                            output */
#define LL_TIM_TRGO_UPDATE TIM_CR2_MMS_1 /*!< Update event is used as trigger output */
#define LL_TIM_TRGO_CC1IF                                                                                              \
    (TIM_CR2_MMS_1 | TIM_CR2_MMS_0)                        /*!< CC1 capture or a compare match is                      \
...
#define LL_TIM_TRGO2_ENABLE                                                                                            \
    TIM_CR2_MMS2_0                         /*!< Counter Enable signal (CNT_EN) is used as trigger                      \
                                              output 2 */
...
#define LL_TIM_TRGO2_OC4                                                                                               \
    (TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0)     /*!< OC4REF signal is used as trigger output 2 */
...
#define LL_TIM_TRGO2_OC6_RISINGFALLING                                                                                 \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC6REF rising or falling edges are used as trigger         \
                                                          output 2 */
...
#define LL_TIM_TRGO2_OC4_RISING_OC6_FALLING                                                                            \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_0) /*!< OC4REF rising or OC6REF falling edges are used as          \
                                                          trigger output 2 */
#define LL_TIM_TRGO2_OC5_RISING_OC6_RISING                                                                             \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1) /*!< OC5REF or OC6REF rising edges are used as trigger          \
                                                          output 2 */
#define LL_TIM_TRGO2_OC5_RISING_OC6_FALLING                                                                            \
    (TIM_CR2_MMS2_3 | TIM_CR2_MMS2_2 | TIM_CR2_MMS2_1 | TIM_CR2_MMS2_0) /*!< OC5REF rising or OC6REF falling edges are \
                                                                           used as trigger output 2 */
/**
 * @}
 */
...
#define LL_TIM_SLAVEMODE_GATED                                                                                         \
    (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_0) /*!< Gated Mode - The counter clock is enabled when the                          \
                                         trigger input (TRGI) is high */
#define LL_TIM_SLAVEMODE_TRIGGER                                                                                       \
    (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1) /*!< Trigger Mode - The counter starts at a rising edge                          \
                                         of the trigger TRGI */
#define LL_TIM_SLAVEMODE_COMBINED_RESETTRIGGER                                                                         \
    TIM_SMCR_SMS_3 /*!< Combined reset + trigger mode - Rising edge of the                                             \
                      selected trigger input (TRGI)  reinitializes the                                                 \
...
#define LL_TIM_TS_ITR7                                                                                                 \
    (TIM_SMCR_TS_3 | TIM_SMCR_TS_1 | TIM_SMCR_TS_0) /*!< Internal Trigger 7 (ITR7) is used as trigger input */
#endif                                              /* USB_BASE */
#define LL_TIM_TS_TI1F_ED TIM_SMCR_TS_2             /*!< TI1 Edge Detector (TI1F_ED) is used as trigger input */
#define LL_TIM_TS_TI1FP1                                                                                               \
    (TIM_SMCR_TS_2 | TIM_SMCR_TS_0) /*!< Filtered Timer Input 1 (TI1FP1) is                                            \
                                       used as trigger input */
#define LL_TIM_TS_TI2FP2                                                                                               \
    (TIM_SMCR_TS_2 | TIM_SMCR_TS_1) /*!< Filtered Timer Input 2 (TI12P2) is                                            \
                                       used as trigger input */
#define LL_TIM_TS_ETRF                                                                                                 \
    (TIM_SMCR_TS_2 | TIM_SMCR_TS_1 | TIM_SMCR_TS_0) /*!< Filtered external Trigger (ETRF) is used as trigger           \
                                                       input */
/**
 * @}
 */
...
#endif                                                                 /* COMP3 */
#define LL_TIM_ETRSOURCE_ADC1_AWD1                                                                                     \
    (TIM1_AF1_ETRSEL_1 | TIM1_AF1_ETRSEL_0)          /*!< ETR input is connected to                                    \
...
#define LL_TIM_ETRSOURCE_ADC1_AWD3                                                                                     \
    (TIM1_AF1_ETRSEL_2 | TIM1_AF1_ETRSEL_0)                           /*!< ETR input is connected to                   \
...
#define LL_TIM_OSSI_ENABLE                                                                                             \
    TIM_BDTR_OSSI /*!< When inactive, OxC/OCxN outputs are first forced with                                           \
                     their inactive level then forced to their idle level                                              \
                     after the deadtime */
/**
 * @}
 */
...
#define LL_TIM_DMABURST_BASEADDR_SMCR                                                                                  \
    TIM_DCR_DBA_1 /*!< TIMx_SMCR register is the DMA base address for DMA                                              \
                     burst */
...
#define LL_TIM_DMABURST_BASEADDR_CCMR2                                                                                 \
    (TIM_DCR_DBA_2 | TIM_DCR_DBA_1 | TIM_DCR_DBA_0) /*!< TIMx_CCMR2 register is the DMA base address for DMA           \
                                                       burst */
#define LL_TIM_DMABURST_BASEADDR_CCER                                                                                  \
    TIM_DCR_DBA_3 /*!< TIMx_CCER register is the DMA base address for DMA                                              \
                     burst */
...
#define LL_TIM_DMABURST_BASEADDR_ARR                                                                                   \
    (TIM_DCR_DBA_3 | TIM_DCR_DBA_1 | TIM_DCR_DBA_0) /*!< TIMx_ARR register is the DMA base address for DMA             \
                                                       burst */
...
#define LL_TIM_DMABURST_BASEADDR_CCR1                                                                                  \
    (TIM_DCR_DBA_3 | TIM_DCR_DBA_2 | TIM_DCR_DBA_0) /*!< TIMx_CCR1 register is the DMA base address for DMA            \
                                                       burst */
#define LL_TIM_DMABURST_BASEADDR_CCR2                                                                                  \
    (TIM_DCR_DBA_3 | TIM_DCR_DBA_2 | TIM_DCR_DBA_1) /*!< TIMx_CCR2 register is the DMA base address for DMA            \
                                                       burst */
#define LL_TIM_DMABURST_BASEADDR_CCR3                                                                                  \
    (TIM_DCR_DBA_3 | TIM_DCR_DBA_2 | TIM_DCR_DBA_1 | TIM_DCR_DBA_0) /*!< TIMx_CCR3 register is the DMA base address    \
                                                                       for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_CCR4                                                                                  \
    TIM_DCR_DBA_4 /*!< TIMx_CCR4 register is the DMA base address for DMA                                              \
                     burst */
#define LL_TIM_DMABURST_BASEADDR_BDTR                                                                                  \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_0) /*!< TIMx_BDTR register is the DMA base                                            \
                                       address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_OR1                                                                                   \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2) /*!< TIMx_OR1 register is the DMA base                                             \
                                       address for DMA burst */
#define LL_TIM_DMABURST_BASEADDR_CCMR3                                                                                 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 | TIM_DCR_DBA_0) /*!< TIMx_CCMR3 register is the DMA base address for DMA           \
                                                       burst */
#define LL_TIM_DMABURST_BASEADDR_CCR5                                                                                  \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 | TIM_DCR_DBA_1) /*!< TIMx_CCR5 register is the DMA base address for DMA            \
                                                       burst */
#define LL_TIM_DMABURST_BASEADDR_CCR6                                                                                  \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2 | TIM_DCR_DBA_1 | TIM_DCR_DBA_0) /*!< TIMx_CCR6 register is the DMA base address    \
                                                                       for DMA burst */
...
#define LL_TIM_DMABURST_BASEADDR_AF2                                                                                   \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 | TIM_DCR_DBA_0) /*!< TIMx_AF2 register is the DMA base address for DMA             \
                                                       burst */
#define LL_TIM_DMABURST_BASEADDR_TISEL                                                                                 \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_3 | TIM_DCR_DBA_1) /*!< TIMx_TISEL register is the DMA base address for DMA           \
                                                       burst */
/**
 * @}
 */
...
#define LL_TIM_DMABURST_LENGTH_1TRANSFER                                                                               \
    0x00000000U /*!< Transfer is done to 1 register starting from the DMA                                              \
                   burst base address */
...
#define LL_TIM_DMABURST_LENGTH_4TRANSFERS                                                                              \
    (TIM_DCR_DBL_1 | TIM_DCR_DBL_0) /*!< Transfer is done to 4 registers starting from the DMA                         \
                                       burst base address */
...
#define LL_TIM_DMABURST_LENGTH_6TRANSFERS                                                                              \
    (TIM_DCR_DBL_2 | TIM_DCR_DBL_0) /*!< Transfer is done to 6 registers starting from the DMA                         \
                                       burst base address */
#define LL_TIM_DMABURST_LENGTH_7TRANSFERS                                                                              \
    (TIM_DCR_DBL_2 | TIM_DCR_DBL_1) /*!< Transfer is done to 7 registers starting from the DMA                         \
                                       burst base address */
#define LL_TIM_DMABURST_LENGTH_8TRANSFERS                                                                              \
    (TIM_DCR_DBL_2 | TIM_DCR_DBL_1 | TIM_DCR_DBL_0) /*!< Transfer is done to 1 registers starting from the DMA         \
                                                       burst base address */
...
#define LL_TIM_DMABURST_LENGTH_10TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_0) /*!< Transfer is done to 10 registers starting from the                            \
                                       DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_11TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_1) /*!< Transfer is done to 11 registers starting from the                            \
                                       DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_12TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_1 | TIM_DCR_DBL_0) /*!< Transfer is done to 12 registers starting from the            \
                                                       DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_13TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_2) /*!< Transfer is done to 13 registers starting from the                            \
                                       DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_14TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_2 | TIM_DCR_DBL_0) /*!< Transfer is done to 14 registers starting from the            \
                                                       DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_15TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_2 | TIM_DCR_DBL_1) /*!< Transfer is done to 15 registers starting from the            \
                                                       DMA burst base address */
#define LL_TIM_DMABURST_LENGTH_16TRANSFERS                                                                             \
    (TIM_DCR_DBL_3 | TIM_DCR_DBL_2 | TIM_DCR_DBL_1 | TIM_DCR_DBL_0) /*!< Transfer is done to 16 registers starting     \
...
#define LL_TIM_DMABURST_LENGTH_18TRANSFERS                                                                             \
    (TIM_DCR_DBL_4 | TIM_DCR_DBL_0) /*!< Transfer is done to 18 registers starting from the                            \
                                       DMA burst base address */
/**
 * @}
 */
...
#define LL_TIM_TIM16_TI1_RMP_RTC_WK                                                                                    \
    (TIM_TISEL_TI1SEL_0 | TIM_TISEL_TI1SEL_1)        /*!< TIM16 input 1 is connected to RTC_WAKEUP */
...
#define __LL_TIM_GET_ICPSC_RATIO(__ICPSC__) ((uint32_t)(0x01U << (((__ICPSC__) >> 16U) >> TIM_CCMR1_IC1PSC_Pos)))
    ...
    __STATIC_INLINE uint32_t LL_TIM_OC_GetMode(const TIM_TypeDef *TIMx, uint32_t Channel)
    {
        ...
        const __IO uint32_t *pReg =
            (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->CCMR1) + OFFSET_TAB_CCMRx[iChannel]));
...
#endif /* TIM1 || TIM2 || TIM3 || TIM4 || TIM14 || TIM15 || TIM16 || TIM17 ||                                          \
          TIM6 || TIM7 */
