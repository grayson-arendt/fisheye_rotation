...
#define PACKAGE_BASE_ADDRESS PACKAGE_BASE
    ...
    typedef struct
    {
        uint32_t AHBCLKDivider; /*!< The AHB clock (HCLK) divider. This clock is derived
                                   ...
                                   a value of @ref RCC_LL_EC_SYSCLK_DIV
...
#elif defined(STM32G061xx) || defined(STM32G051xx) || defined(STM32G050xx) || defined(STM32G041xx) ||                  \
    defined(STM32G031xx) || defined(STM32G030xx)
...
#define LL_UTILS_PACKAGETYPE_QFP64 0x0000000CU    /*!< LQPF64 package type                                 */
     ...
     * @retval PKG[3:0]: Package type - This parameter can be a value of @ref
