 ...
 */
#define __STM32G0xx_HAL_VERSION_MAIN (0x01UL) /*!< [31:24] main version */
#define __STM32G0xx_HAL_VERSION_SUB1 (0x04UL) /*!< [23:16] sub1 version */
#define __STM32G0xx_HAL_VERSION_SUB2 (0x07UL) /*!< [15:8]  sub2 version */
#define __STM32G0xx_HAL_VERSION_RC (0x00UL)   /*!< [7:0]  release candidate */
#define __STM32G0xx_HAL_VERSION                                                                                        \
    ((__STM32G0xx_HAL_VERSION_MAIN << 24UL) | (__STM32G0xx_HAL_VERSION_SUB1 << 16UL) |                                 \
     (__STM32G0xx_HAL_VERSION_SUB2 << 8UL) | (__STM32G0xx_HAL_VERSION_RC))
 ...
 *         by calling the HAL_MspInit() callback function to be optionally
 * defined in user file stm32g0xx_hal_msp.c.
 *
 ...
 * is the clock used after a system Reset. Once done, time base tick starts
 ...
 * @param  ConfigDeadBattery specifies on which pins to make effective or not
 * Dead Battery sw configuration This parameter can be any combination of the
 * following values:
