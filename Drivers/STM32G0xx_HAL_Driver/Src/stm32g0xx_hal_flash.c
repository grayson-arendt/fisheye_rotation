/**
 ...
 FLASH memory of all STM32G0xx devices.
 ...
 * address where are stored the data for the row fast program depending on the
 * TypeProgram: TypeProgram = FLASH_TYPEPROGRAM_DOUBLEWORD (64-bit) TypeProgram
 * = FLASH_TYPEPROGRAM_FAST (32-bit).
 *
 ...
 * procedure Mass Erase: 0 Page Erase: Page which has been erased Program:
 * Address which was selected for data program
 * @retval None
 */
 ...
 * @param  ReturnValue The value saved in this parameter depends on the ongoing
 * procedure Mass Erase: 0 Page Erase: Page number which returned an error
