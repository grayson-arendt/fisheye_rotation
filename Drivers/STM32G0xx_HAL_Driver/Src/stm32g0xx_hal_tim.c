...
__weak void HAL_TIM_OnePulse_MspDeInit(TIM_HandleTypeDef *htim)
{
    ...
    /* NOTE : This function should not be modified, when the callback is needed,
              the HAL_TIM_OnePulse_MspDeInit could be implemented in the user
       file
     */
}
...
HAL_StatusTypeDef HAL_TIM_OnePulse_Stop(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
    ...
    TIM_CHANNEL_2 will be used as input and if TIM_CHANNEL_1 is used as input,
    the TIM_CHANNEL_2 will be used as output whatever the combination, the
    TIM_CHANNEL_1 and TIM_CHANNEL_2 should be disabled together */
...
HAL_StatusTypeDef HAL_TIM_Encoder_Init(TIM_HandleTypeDef *htim, const TIM_Encoder_InitTypeDef *sConfig)
{
    ...
    /* Set the Capture Compare 1 and the Capture Compare 2 prescalers and
     * filters */
...
__weak void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef *htim)
{
    ...
    /* NOTE : This function should not be modified, when the callback is needed,
              the HAL_TIM_Encoder_MspDeInit could be implemented in the user
       file
     */
}
                                            ...
                                            uint32_t *pData2, uint16_t Length)
{
    ...
    else
    {
        ...
        else if ((channel_1_state == HAL_TIM_CHANNEL_STATE_READY) && (channel_2_state == HAL_TIM_CHANNEL_STATE_READY) &&
                 (complementary_channel_1_state == HAL_TIM_CHANNEL_STATE_READY) &&
                 (complementary_channel_2_state == HAL_TIM_CHANNEL_STATE_READY))
        {
                                           ...
                                           const TIM_ClearInputConfigTypeDef *sClearInputConfig, uint32_t Channel)
{
    ...
    case TIM_CLEARINPUTSOURCE_ETR: {
        ...
        /* When OCRef clear feature is used with ETR source, ETR prescaler
         * must be off */
...
HAL_StatusTypeDef HAL_TIM_ConfigClockSource(TIM_HandleTypeDef *htim, const TIM_ClockConfigTypeDef *sClockSourceConfig)
{
    ...
    case TIM_CLOCKSOURCE_ETRMODE1: {
        /* Check whether or not the timer instance supports external trigger
         * input mode 1 (ETRF)*/
    ...
    case TIM_CLOCKSOURCE_TI1: {
        /* Check whether or not the timer instance supports external clock
         * mode 1 */
    ...
    case TIM_CLOCKSOURCE_ITR3: {
        /* Check whether or not the timer instance supports internal trigger
         * input */
...
__weak void HAL_TIM_OC_DelayElapsedCallback(TIM_HandleTypeDef *htim)
{
    ...
    /* NOTE : This function should not be modified, when the callback is needed,
              the HAL_TIM_OC_DelayElapsedCallback could be implemented in the
       user file
     */
}
...
__weak void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
    ...
    /* NOTE : This function should not be modified, when the callback is needed,
              the HAL_TIM_IC_CaptureCallback could be implemented in the user
       file
     */
}
...
__weak void HAL_TIM_TriggerHalfCpltCallback(TIM_HandleTypeDef *htim)
{
    ...
    /* NOTE : This function should not be modified, when the callback is needed,
              the HAL_TIM_TriggerHalfCpltCallback could be implemented in the
       user file
     */
}
...
void TIM_Base_SetConfig(TIM_TypeDef *TIMx, const TIM_Base_InitTypeDef *Structure)
{
    ...
    /* Ensure that the update event is generated before writing back CR1
     * register with URS = 0 */
    __DSB();
