...
__weak void HAL_TIMEx_HallSensor_MspDeInit(TIM_HandleTypeDef *htim)
{
    ...
    /* NOTE : This function should not be modified, when the callback is needed,
              the HAL_TIMEx_HallSensor_MspDeInit could be implemented in the
       user file
     */
}
...
HAL_StatusTypeDef HAL_TIMEx_HallSensor_Start(TIM_HandleTypeDef *htim)
{
    ...
    (in the Hall Sensor Interface the three possible channels that can be used
    are TIM_CHANNEL_1, TIM_CHANNEL_2 and TIM_CHANNEL_3) */
 ...
 *            @arg TIM_TIM1_ETR_GPIO:                TIM1 ETR is is connected to
 * GPIO
 *            @arg TIM_TIM1_ETR_COMP1:               TIM1 ETR is connected to
 * COMP1 output
 *            @arg TIM_TIM1_ETR_COMP2:               TIM1 ETR is connected to
 * COMP2 output
 *            @arg TIM_TIM1_ETR_COMP3:               TIM1 ETR is connected to
 * COMP3 output    (**)
 *            @arg TIM_TIM1_ETR_ADC1_AWD1:           TIM1 ETR is connected to
 * ADC1 AWD1
 *            @arg TIM_TIM1_ETR_ADC1_AWD2:           TIM1 ETR is connected to
 * ADC1 AWD2
 *            @arg TIM_TIM1_ETR_ADC1_AWD3:           TIM1 ETR is connected to
 * ADC1 AWD3
 *
 *         For TIM2, the parameter can take one of the following values: (*)
 *            @arg TIM_TIM2_ETR_GPIO:                TIM2_ETR is connected to
 * GPIO
 *            @arg TIM_TIM2_ETR_COMP1:               TIM2_ETR is connected to
 * COMP1 output
 *            @arg TIM_TIM2_ETR_COMP2:               TIM2_ETR is connected to
 * COMP2 output
 *            @arg TIM_TIM2_ETR_COMP3:               TIM2_ETR is connected to
 * COMP3 output    (**)
 *            @arg TIM_TIM2_ETR_LSE:                 TIM2_ETR is connected to
 * LSE
 *            @arg TIM_TIM2_ETR_MCO:                 TIM2_ETR is connected to
 * MCO             (**)
 *            @arg TIM_TIM2_ETR_MCO2:                TIM2_ETR is connected to
 * MCO2            (**)
 *
 *         For TIM3, the parameter can take one of the following values:
 *            @arg TIM_TIM3_ETR_GPIO                TIM3_ETR is connected to
 * GPIO
 *            @arg TIM_TIM3_ETR_COMP1               TIM3_ETR is connected to
 * COMP1 output
 *            @arg TIM_TIM3_ETR_COMP2               TIM3_ETR is connected to
 * COMP2 output
 *            @arg TIM_TIM3_ETR_COMP3               TIM3_ETR is connected to
 * COMP3 output    (**)
 *
 *         For TIM4, the parameter can take one of the following values:(*)
 *            @arg TIM_TIM4_ETR_GPIO                TIM4_ETR is connected to
 * GPIO
 *            @arg TIM_TIM4_ETR_COMP1               TIM4_ETR is connected to
 * COMP1 output
 *            @arg TIM_TIM4_ETR_COMP2               TIM4_ETR is connected to
 * COMP2 output
 *            @arg TIM_TIM4_ETR_COMP3               TIM4_ETR is connected to
 * COMP3 output    (**)
 *
 ...
 * COMP1 output
 *            @arg TIM_TIM1_TI2_GPIO:                TIM1 TI2 is connected to
 * GPIO
 *            @arg TIM_TIM1_TI2_COMP2:               TIM1 TI2 is connected to
 * COMP2 output
 *            @arg TIM_TIM1_TI3_GPIO:                TIM1 TI3 is connected to
 * GPIO
 *            @arg TIM_TIM1_TI3_COMP3:               TIM1 TI3 is connected to
 * COMP3 output   (**)
 *
 ...
 * COMP1 output
 *            @arg TIM_TIM2_TI2_GPIO:                TIM2 TI2 is connected to
 * GPIO
 *            @arg TIM_TIM2_TI2_COMP2:               TIM2 TI2 is connected to
 * COMP2 output
 *            @arg TIM_TIM2_TI3_GPIO:                TIM2 TI3 is connected to
 * GPIO
 *            @arg TIM_TIM2_TI3_COMP3:               TIM2 TI3 is connected to
 * COMP3 output   (**)
 *
 ...
 * GPIO
 *            @arg TIM_TIM4_TI3_COMP3:               TIM4 TI3 is connected to
 * COMP3 output
 *
 *         For TIM14, the parameter is one of the following values:
 *            @arg TIM_TIM14_TI1_GPIO:               TIM14 TI1 is connected to
 * GPIO
 *            @arg TIM_TIM14_TI1_RTC:                TIM14 TI1 is connected to
 * RTC clock
 *            @arg TIM_TIM14_TI1_HSE_32:             TIM14 TI1 is connected to
 * HSE div 32
 *            @arg TIM_TIM14_TI1_MCO:                TIM14 TI1 is connected to
 * MCO
 *            @arg TIM_TIM14_TI1_MCO2:               TIM14 TI1 is connected to
 * MCO2          (**)
 *
 *         For TIM15, the parameter is one of the following values:
 *            @arg TIM_TIM15_TI1_GPIO:               TIM15 TI1 is connected to
 * GPIO
 *            @arg TIM_TIM15_TI1_TIM2_CH1:           TIM15 TI1 is connected to
 * TIM2 CH1
 *            @arg TIM_TIM15_TI1_TIM3_CH1:           TIM15 TI1 is connected to
 * TIM3 CH1
 *            @arg TIM_TIM15_TI2_GPIO:               TIM15 TI2 is connected to
 * GPIO
 *            @arg TIM_TIM15_TI2_TIM2_CH2:           TIM15 TI2 is connected to
 * TIM2 CH2
 *            @arg TIM_TIM15_TI2_TIM3_CH2:           TIM15 TI2 is connected to
 * TIM3 CH2
 *
 *         For TIM16, the parameter can have the following values:
 *            @arg TIM_TIM16_TI1_GPIO:               TIM16 TI1 is connected to
 * GPIO
 *            @arg TIM_TIM16_TI1_LSI:                TIM16 TI1 is connected to
 * LSI
 *            @arg TIM_TIM16_TI1_LSE:                TIM16 TI1 is connected to
 * LSE
 *            @arg TIM_TIM16_TI1_RTC_WAKEUP:         TIM16 TI1 is connected to
 * TRC wakeup interrupt
 *            @arg TIM_TIM16_TI1_MCO2:               TIM16 TI1 is connected to
 * MCO2          (**)
 *
 *         For TIM17, the parameter can have the following values:
 *            @arg TIM_TIM17_TI1_GPIO:               TIM17 TI1 is connected to
 * GPIO
 *            @arg TIM_TIM14_TI1_HSI:                TIM17 TI1 is connected to
 * HSI           (**)
 *            @arg TIM_TIM17_TI1_HSE_32:             TIM17 TI1 is connected to
 * HSE div 32
 *            @arg TIM_TIM17_TI1_MCO:                TIM17 TI1 is connected to
 * MCO
 *            @arg TIM_TIM17_TI1_MCO2:               TIM17 TI1 is connected to
 * MCO2          (**)
 *
 *  (*) Timer instance not available on all devices \n
 *  (**) Value not defined in all devices. \n
...
HAL_StatusTypeDef HAL_TIMEx_DisarmBreakInput(TIM_HandleTypeDef *htim, uint32_t BreakInput)
{
    ...
    case TIM_BREAKINPUT_BRK: {
        ...
        if ((READ_BIT(tmpbdtr, TIM_BDTR_BKBID) == TIM_BDTR_BKBID) && (READ_BIT(tmpbdtr, TIM_BDTR_MOE) == 0U))
        {
    ...
    case TIM_BREAKINPUT_BRK2: {
        /* Check initial conditions */
        tmpbdtr = READ_REG(htim->Instance->BDTR);
        if ((READ_BIT(tmpbdtr, TIM_BDTR_BK2BID) == TIM_BDTR_BK2BID) && (READ_BIT(tmpbdtr, TIM_BDTR_MOE) == 0U))
        {
            /* Break input BRK is disarmed */
...
HAL_StatusTypeDef HAL_TIMEx_ReArmBreakInput(const TIM_HandleTypeDef *htim, uint32_t BreakInput)
{
    ...
    case TIM_BREAKINPUT_BRK: {
        ...
        {
            /* Break input BRK is re-armed automatically by hardware. Poll
             * to check whether fault condition disappeared */
    ...
    case TIM_BREAKINPUT_BRK2: {
        ...
        {
            /* Break input BRK2 is re-armed automatically by hardware. Poll
             * to check whether fault condition disappeared */
            /* Init tickstart for timeout management */
            tickstart = HAL_GetTick();
