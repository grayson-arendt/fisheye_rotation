...
#define IS_LL_RCC_LPUART_CLKSOURCE(__VALUE__)                                                                          \
    (((__VALUE__) == LL_RCC_LPUART1_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPUART2_CLKSOURCE))
...
#define IS_LL_RCC_I2S_CLKSOURCE(__VALUE__)                                                                             \
    (((__VALUE__) == LL_RCC_I2S1_CLKSOURCE) || ((__VALUE__) == LL_RCC_I2S2_CLKSOURCE))
#else
...
#define IS_LL_RCC_TIM_CLKSOURCE(__VALUE__)                                                                             \
    (((__VALUE__) == LL_RCC_TIM1_CLKSOURCE) || ((__VALUE__) == LL_RCC_TIM15_CLKSOURCE))
 ...
 * @brief  Return the frequencies of different on chip clocks;  System, AHB and
 * APB1 buses clocks and different peripheral clocks available on the device.
 * @note   If SYSCLK source is HSI, function returns values based on HSI_VALUE
 * divided by HSI division factor(**)
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI or
 * LSE) is not ready
 */
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that HSI oscillator is
 * not ready
 */
 ...
 *         @arg @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator is
 * not ready
 */
 ...
 *         @arg @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI
 * or LSE) is not ready
...
uint32_t LL_RCC_GetLPUARTClockFreq(uint32_t LPUARTxSource)
{
    ...
    if (LPUARTxSource == LL_RCC_LPUART1_CLKSOURCE)
    {
        ...
        {
        case LL_RCC_LPUART1_CLKSOURCE_SYSCLK: /* LPUART1 Clock is System
                                                 Clock */
    ...
    else if (LPUARTxSource == LL_RCC_LPUART2_CLKSOURCE)
    {
        ...
        switch (LL_RCC_GetLPUARTClockSource(LPUARTxSource))
        {
        case LL_RCC_LPUART2_CLKSOURCE_SYSCLK: /* LPUART2 Clock is System
                                                 Clock */
            lpuart_frequency = RCC_GetSystemClockFreq();
            break;
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI,
 * LSI or LSE) is not ready
 */
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI) or
 * PLL is not ready
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NA indicates that no clock source
 * selected
 */
uint32_t LL_RCC_GetRNGClockFreq(uint32_t RNGxSource)
{
    ...
    case LL_RCC_RNG_CLKSOURCE_HSI_DIV8: /* HSI clock divided by 8 used as
                                           RNG clock source */
        rng_frequency = HSI_VALUE / 8U;
        rngdiv = (1UL << ((READ_BIT(RCC->CCIPR, RCC_CCIPR_RNGDIV)) >> RCC_CCIPR_RNGDIV_Pos));
        rng_frequency = (rng_frequency / rngdiv);
        break;
    case LL_RCC_RNG_CLKSOURCE_SYSCLK: /* SYSCLK clock used as RNG clock
                                         source */
...
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
    ...
    {
    case LL_RCC_ADC_CLKSOURCE_SYSCLK: /* SYSCLK clock used as ADC clock
                                         source */
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillators (LSI,
 * LSE or HSE) are not ready
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NA indicates that no clock source
 * selected
 */
uint32_t LL_RCC_GetRTCClockFreq(void)
{
    ...
    case LL_RCC_RTC_CLKSOURCE_HSE_DIV32: /* HSE clock used as ADC clock
                                            source */
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI48)
 * or PLL is not ready
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NA indicates that no clock source
 * selected
 */
...
static uint32_t RCC_PLL_GetFreqDomain_FDCAN(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_FDCAN_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetQ());
}
#endif /* FDCAN1 || FDCAN2 */
...
static uint32_t RCC_PLL_GetFreqDomain_I2S1(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_I2S1_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetP());
}
...
static uint32_t RCC_PLL_GetFreqDomain_I2S2(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_I2S2_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetP());
}
#endif /* RCC_CCIPR2_I2S2SEL */
...
static uint32_t RCC_PLL_GetFreqDomain_USB(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_USB_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetQ());
}
#endif /* STM32G0C1xx || STM32G0B1xx || STM32G0B0xx */
...
static uint32_t RCC_PLL_GetFreqDomain_TIM1(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_TIM1_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetQ());
}
...
static uint32_t RCC_PLL_GetFreqDomain_TIM15(void)
{
    ...
    */
    ...
    return __LL_RCC_CALC_PLLCLK_TIM15_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(), LL_RCC_PLL_GetQ());
}
#endif /* RCC_CCIPR_TIM15SEL */
/**
 * @}
